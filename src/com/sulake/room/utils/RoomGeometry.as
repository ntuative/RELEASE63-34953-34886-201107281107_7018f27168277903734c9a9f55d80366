package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_626:Number = 64;
      ...
      private var var_1811:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1813 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_447.assign(this.var_105);
         this.var_447.x *= this.var_449;
         this.var_447.y *= this.var_451;
         this.var_447.z *= this.var_448;
         return this.var_447;
      }
      ...
      {
         if(this.var_449 != param1 * this.var_1812)
         {
            this.var_449 = param1 * this.var_1812;
            ++this.var_176;
         }
      }
      ...
      {
         if(this.var_451 != param1 * this.var_1811)
         {
            this.var_451 = param1 * this.var_1811;
            ++this.var_176;
         }
      }
      ...
      {
         if(this.var_448 != param1 * this.var_1813)
         {
            this.var_448 = param1 * this.var_1813;
            ++this.var_176;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_105.x /= this.var_449;
         this.var_105.y /= this.var_451;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1193.assign(this.var_178);
         }
         else
         {
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_536 != null)
         {
            ...
            return this.var_536.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1194.assign(_loc22_);
         }
         else
         {
            this.var_1194.assign(_loc17_);
         }
         ++this.var_176;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_449;
         _loc2_.y *= this.var_451;
         _loc2_.z *= this.var_448;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1194);
         if(_loc3_ < this.var_3089 || _loc3_ > this.var_3088)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_451;
            _loc2_.z *= this.var_448;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1194);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_105.x * this.var_449,this.var_105.y * this.var_451,this.var_105.z * this.var_448);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_178;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_449,param2.y * this.var_451,param2.z * this.var_448);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_449,param3.y * this.var_451,param3.z * this.var_448);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_449,param4.y * this.var_451,param4.z * this.var_448);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_626;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_626;
      }
