package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_431:IRoomObjectController;
      ...
      {
         if(this.var_431 == param1)
         {
            return;
         }
         if(this.var_431 != null)
         {
            this.var_431.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_431 = param1;
            this.var_431.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_431 != null)
            {
               this.var_431.setLocation(param1.loc);
               this.var_431.setDirection(param1.dir);
            }
         }
      }
