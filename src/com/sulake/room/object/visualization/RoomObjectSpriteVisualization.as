package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_431:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_226 != null)
         {
            ...
            {
               _loc1_ = this.var_226[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_858.removeReference();
         }
         this.var_858 = param1;
         if(this.var_858 != null)
         {
            this.var_858.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_226.length > param1)
         {
            _loc2_ = this.var_226[this.var_226.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
         ...
         while(this.var_226.length < param1)
         {
            ...
            this.var_226.push(_loc2_);
         }
      }
      
      public function get spriteCount() : int
      {
         return this.var_226.length;
      }
      
      public function getSprite(param1:int) : IRoomObjectSprite
      {
         if(param1 >= 0 && param1 < this.var_226.length)
         {
