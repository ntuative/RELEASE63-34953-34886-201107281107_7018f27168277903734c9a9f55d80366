package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectSortableSpriteCacheItem
   {
      ...
      {
         if(param1 != this.var_2837 || param2 != this.var_2838)
         {
      ...
      public function setSpriteCount(param1:int) : void
      {
         ...
         if(param1 < this.var_226.length)
         {
            ...
            this.var_226.splice(param1,this.var_226.length - param1);
         }
         if(this.var_226.length == 0)
         {
            this.var_2087 = true;
         }
         else
