package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class SetFurniStateTo implements ActionType
   {
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.method_3(this.getStateInput(param1)));
         _loc2_.push(this.method_3(this.getRotationInput(param1)));
         _loc2_.push(this.method_3(this.getLocationInput(param1)));
         return _loc2_;
      }
      ...
      private function method_3(param1:ICheckBoxWindow) : int
      {
