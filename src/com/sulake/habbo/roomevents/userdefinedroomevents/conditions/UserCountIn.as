package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1173:SliderWindowController;
      ...
      {
         return ConditionCodes.var_2255;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1172.getValue());
         _loc2_.push(this.var_1173.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_94 = param2;
         this.var_1172 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1172.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1172.setValue(1);
         this.var_1173 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1173.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1173.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1172.setValue(_loc3_);
         this.var_1173.setValue(_loc4_);
      }
