package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1582:int = 2;
      ...
      private var var_2016:TriggerConfs;
      
      private var var_2018:ActionTypes;
      
      private var var_2017:ConditionTypes;
      
      private var var_295:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_854:RoomObjectHightLighter;
      
      private var var_210:UserDefinedRoomEventsHelp;
      
      private var var_1300:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2016 = new TriggerConfs();
         this.var_2018 = new ActionTypes();
         this.var_2017 = new ConditionTypes();
         this.var_295 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_854 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_295[param1])
         {
            delete this.var_295[param1];
            this.var_854.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_295[param1] = param2;
            this.var_854.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1300 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_57,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1300.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1300.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_854.hideAll(this.var_295);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1300.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1582) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1582 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2016);
         this.refreshConfigureElement(this.var_2018);
         this.refreshConfigureElement(this.var_2017);
