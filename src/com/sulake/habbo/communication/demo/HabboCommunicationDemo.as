package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_589:IKeyExchange;
      
      private var var_1104:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2886:PseudoRandom;
      ...
      private var var_262:HabboHotelView;
      
      private var var_1646:String = "";
      
      private const const_2126:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_726 = param1;
            this.var_65.initConnection(HabboConnectionType.const_314);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_83,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_65 && this.var_158 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:Boolean = this.var_158.getBoolean("client.hotel_view.show_on_startup",true);
         this.var_262 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         var _loc2_:String = this.var_158.getKey("client.hotel_view.image");
         var _loc3_:String = this.var_158.getKey("image.library.url");
         if(_loc2_ != null && _loc3_ != null)
         {
            this.var_262.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_158.getKey("use.sso.ticket") == "1";
         this.var_726 = this.var_158.getKey("sso.ticket",null);
         this.var_2102 = this.var_158.getKey("flash.client.url","");
         this.var_2888 = this.var_158.getKey("external.variables.txt","");
         if(this.var_262 == null)
         {
            this.var_262 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_990,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1777);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_65.mode = HabboConnectionType.const_1325;
            }
         }
         this.var_65.initConnection(HabboConnectionType.const_314);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2886 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_65.mode)
         {
            case HabboConnectionType.const_99:
               ...
               this.var_1646 = _loc4_;
               this.var_262.loadBannerImage(_loc7_ + "?token=" + this.var_1646,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1325:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_2035:
               this.var_1104 = this.generateRandomHexString(30);
               this.var_589 = new DiffieHellman(new BigInteger(this.var_158.getKey("connection.development.prime"),16),new BigInteger(this.var_158.getKey("connection.development.generator"),16));
               this.var_589.init(this.var_1104);
               _loc8_ = this.var_589.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_589.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_589.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2886);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_2102,this.var_2888));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2126,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_726 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_726);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2887)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1646);
         ...
         this.var_589 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_589.init(_loc14_);
            _loc15_ = this.var_589.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1104 = _loc14_;
            }
