package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_990:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_143.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_153,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_2126,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_143.habboConfiguration.getKey("use.sso","false") == "true")
               {
                  _loc8_.select();
               }
            }
         ...
         if(this.var_143.habboConfiguration && this.var_143.habboConfiguration.getKey("try.existing.session","false") == "true")
         {
            this.var_1693 = true;
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_2126,"/");
         ...
         {
            dispatchEvent(new Event(const_990));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         if(this.var_162 != null)
         {
            ...
            this.var_162.removeEventListener(SSOTicket.const_349,this.onParsedTicketFailure);
            this.var_162 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_162 = new SSOTicket(this.var_143.assets,_loc3_,_loc2_,param1);
         this.var_162.addEventListener(SSOTicket.const_415,this.onParsedTicketSuccess);
         this.var_162.addEventListener(SSOTicket.const_349,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_143.flashClientUrl = this.var_162.flashClientUrl;
         this.var_143.ssoTicket = this.var_162.ticket;
         this.var_162.removeEventListener(SSOTicket.const_415,this.onParsedTicketSuccess);
         this.var_162.removeEventListener(SSOTicket.const_349,this.onParsedTicketFailure);
         this.var_162 = null;
         dispatchEvent(new Event(const_990));
