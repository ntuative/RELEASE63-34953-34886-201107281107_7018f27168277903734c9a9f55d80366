package com.sulake.habbo.communication.messages.incoming.userdefinedroomevents
{
   ...
   public class Triggerable
   {
      ...
      {
         var _loc5_:int = 0;
         this.var_2178 = new Array();
         this.var_1681 = new Array();
         super();
         this.var_2978 = param1.readBoolean();
         ...
         while(_loc3_ < _loc4_)
         {
            this.var_1681.push(param1.readInteger());
            _loc3_++;
         }
