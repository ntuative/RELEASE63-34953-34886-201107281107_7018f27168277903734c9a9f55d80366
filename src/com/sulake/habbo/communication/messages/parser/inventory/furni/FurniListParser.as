package com.sulake.habbo.communication.messages.parser.inventory.furni
{
   ...
   public class FurniListParser implements IMessageParser
   {
      ...
      protected var var_3070:String;
      
      protected var var_3068:int;
      
      protected var var_3069:int;
      
      protected var var_1720:Array;
      ...
      {
         this.var_3070 = param1.readString();
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_1720.push(this.parseItem(param1));
            _loc3_++;
         }
         return true;
      }
