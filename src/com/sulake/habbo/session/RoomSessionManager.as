   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_252)
         {
            ...
            {
               _loc1_ = this.var_252.getKey(0) as String;
               _loc2_ = this.var_252.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1991)
         {
            this.gotoRoom(this.var_2673,this.var_2672,this.var_1992);
            this.var_1991 = false;
            this.var_1992 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         this.var_1573 = true;
         if(this.var_252.getValue(_loc6_) != null)
         {
         ...
         this.var_252.add(_loc6_,_loc7_);
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_261,_loc7_));
         return true;
      }
      
      public function startSession(param1:IRoomSession) : Boolean
      {
         if(param1.state == RoomSessionEvent.const_78)
         {
            return false;
         }
         if(param1.start())
         {
            this.var_1573 = false;
            events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_78,param1));
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = this.var_252.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = this.getRoomIdentifier(param3,param4);
            _loc7_ = this.var_252.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            this.var_252.add(_loc5_,_loc6_);
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return this.var_252.getValue(_loc3_) as IRoomSession;
      }
      
      public function disposeSession(param1:int, param2:int) : void
      {
         var _loc3_:String = this.getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = this.var_252.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
