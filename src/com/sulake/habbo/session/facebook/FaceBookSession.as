package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1116:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1640:String = "sendAccessTokenToServer";
      
      private static const const_1639:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1640,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1639,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1116);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1116);
         }
      }
