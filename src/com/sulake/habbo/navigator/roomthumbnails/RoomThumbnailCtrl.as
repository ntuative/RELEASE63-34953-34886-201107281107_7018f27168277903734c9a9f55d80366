package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2144:IButtonWindow;
      
      private var var_2146:IButtonWindow;
      
      private var var_2145:IButtonWindow;
      
      private var var_2931:IWindowContainer;
      
      private var var_2930:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2144 = IButtonWindow(this.find("bg_tab"));
         this.var_2146 = IButtonWindow(this.find("top_tab"));
         this.var_2145 = IButtonWindow(this.find("obj_tab"));
         this.var_2931 = IWindowContainer(this.find("tile_grid"));
         this.var_2930 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_2144,this.onBgTabButton);
         Util.setProcDirectly(this.var_2146,this.onTopTabButton);
         Util.setProcDirectly(this.var_2145,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_2144,this.var_78.mode != ThumbnailEditorModel.const_39);
         this.setEnabled(this.var_2146,this.var_78.mode != ThumbnailEditorModel.const_64);
         this.setEnabled(this.var_2145,this.var_78.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2930;
         ...
         this.refreshEditImg(_loc1_,"edit_obj",this.var_78.mode == ThumbnailEditorModel.const_35,false);
         if(this.var_78.mode == ThumbnailEditorModel.const_35)
         {
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2931;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_325,HabboWindowStyle.const_47,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_354,HabboWindowStyle.const_47,HabboWindowParam.const_65,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
