package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_619 = new Timer(100);
         this.var_619.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_45 = new Array();
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,104,"a"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,94,"b"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,36,"c"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,84,"d"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,80,"e"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,80,"f"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,416,"i"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,320,"j"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,448,"k"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,352,"l"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,384,"m"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_54,372,"n"));
      ...
      public function dispose() : void
      {
         if(this.var_619)
         {
            this.var_619.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_619.reset();
            this.var_619 = null;
         }
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1730 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1730 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1164 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_194.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
