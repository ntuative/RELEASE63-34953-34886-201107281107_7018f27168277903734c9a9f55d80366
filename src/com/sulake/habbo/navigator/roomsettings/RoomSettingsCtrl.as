package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1212:TextFieldManager;
      ...
      private var var_1214:ICheckBoxWindow;
      
      private var var_1213:ICheckBoxWindow;
      
      private var var_1208:ICheckBoxWindow;
      
      private var var_798:ICheckBoxWindow;
      
      private var var_1844:ITextWindow;
      
      private var var_987:IDropMenuWindow;
      
      private var var_988:IDropMenuWindow;
      
      private var var_2441:IWindowContainer;
      ...
      {
         this.var_379 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_379));
      ...
      {
         if(param1 != this.var_379 || this.var_1210 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1210 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1937)
         {
            this.var_797.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1898)
         {
            this.var_797.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1815)
         {
            this.var_1212.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1975)
         {
            this.setTagError(this.var_986,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_984,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_2015)
         {
            this.setTagError(this.var_986,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_984,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1808)
         {
            this.var_985.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_797.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_797 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1212 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_986 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_984 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_985 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1209 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1214 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1213 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1208 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_798 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1844 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_987 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_988 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2441 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1206 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1211 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         ...
         this.var_1207 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1489 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1489.mouseThreshold = 0;
         this.var_1489.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1207.visible = false;
         if(!this.var_1488)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1842.visible = this.var_1488;
         this.populateForm();
         if(this.var_799)
         {
         ...
         else
         {
            ...
            this.var_1490.visible = true;
            this.var_2441.visible = this.var_1488;
            this.var_1206.height = Util.getLowestPoint(this.var_1206) + 4;
         }
         this.var_1489.text = !!this.var_799 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1206.name,this.var_1211.name,this.var_1490.name,this.var_1842.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_797.setText(_loc1_.name);
         this.var_1212.setText(_loc1_.description);
         this.var_985.setText("");
         this.var_1209.setText("");
         ...
         this.setTag(this.var_986,_loc1_.tags[0]);
         this.setTag(this.var_984,_loc1_.tags[1]);
         if(this.var_1214)
         {
            if(_loc1_.allowPets)
            {
               this.var_1214.select();
            }
            else
            {
               this.var_1214.unselect();
            }
         }
         if(this.var_1213)
         {
         ...
         if(this.var_1208)
         {
            ...
            {
               this.var_1208.select();
            }
            else
            {
               this.var_1208.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_798);
            this.disableWindow(this.var_987);
            this.disableWindow(this.var_988);
            this.disableWindow(this.var_1844);
         }
         else
         {
            this.enableWindow(this.var_798);
            this.enableWindow(this.var_987);
            this.enableWindow(this.var_988);
            this.enableWindow(this.var_1844);
         }
         if(this.var_798)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_798.unselect();
            }
         }
         if(this.var_987)
         {
            this.var_987.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_988)
         {
            this.var_988.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_797.getText();
         _loc2_.description = this.var_1212.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_669;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_122)
         {
            _loc8_ = this.var_985.getText();
            _loc9_ = this.var_1209.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_985.clearErrors();
               this.var_1209.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1214.isSelected;
         _loc2_.allowFoodConsume = this.var_1213.isSelected;
         _loc2_.allowWalkThrough = this.var_1208.isSelected;
         _loc2_.hideWalls = this.var_798.isSelected;
         _loc2_.wallThickness = this.var_987.selection - 2;
         _loc2_.floorThickness = this.var_988.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_986,_loc2_.tags);
         this.addTag(this.var_984,_loc2_.tags);
         this.clearErrors();
         this.var_1210 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_379);
         if(this.var_56 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_56.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_379]);
         _loc2_.show();
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_379));
      }
