package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1568:uint = 13232628;
      
      private static var var_1976:uint = 11129827;
      ...
      private var var_1289:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_339;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_563 = param1;
         if(this.var_1975 == this.var_563)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1974 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_847)
         {
            this.var_847 = this.var_27.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_847)
            {
               return;
            }
            this._window.content.addChild(this.var_847);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_846)
         {
            this.var_846 = this.var_27.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_846)
            {
               return;
            }
            this._window.content.addChild(this.var_846);
         }
         this._window.caption = this.var_27.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_846.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_563;
         }
         this.showView(this.var_846);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_27.localization.registerParameter("help.tutorial.name.available","name",this.var_563);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1289 = new NameSuggestionListRenderer(this.var_27);
         var _loc6_:int = this.var_1289.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1568;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1569)
         {
            if(param1.type == WindowEvent.const_118)
            {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_563 = this.var_27.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_563 != _loc5_)
               {
                  this.var_1975 = _loc5_;
            ...
            case "confirm_name_button":
               this.var_27.changeName(this.var_563);
               break;
