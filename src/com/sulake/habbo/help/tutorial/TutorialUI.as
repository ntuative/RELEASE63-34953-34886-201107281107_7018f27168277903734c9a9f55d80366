package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_339:String = "TUI_NAME_VIEW";
      
      public static const const_433:String = "TUI_CLOTHES_VIEW";
      
      public static const const_602:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_670,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_676,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_641,this.onTaskDoneEvent);
      ...
      {
         return this.var_1227 && this.var_1228 && this.var_1496;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_670,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_676,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_641,this.onTaskDoneEvent);
            if(this.var_36.sessionDataManager != null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_670:
               this.var_1496 = true;
               if(this.var_54 != null && this.var_54.id == const_602)
               {
                  this.showView(const_98);
               }
               break;
            case HabboHelpTutorialEvent.const_676:
               if(this.var_54 != null && this.var_54.id == const_433)
               {
                  this.var_1851 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_641:
               if(this.var_1851)
               {
                  this.var_1851 = false;
                  this.showView(const_98);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2465 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2463;
         this._window.width = _loc2_.width + this.var_2465;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_36.hideUI();
         this.var_36.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_139));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_54 != null && (this.var_54.id == const_339 || this.var_54.id == const_98))
         {
            this.showView(const_98);
         }
      }
      ...
      {
         this.var_1227 = true;
         if(this.var_54 != null && (this.var_54.id == const_433 || this.var_54.id == const_98))
         {
            this.showView(const_98);
         }
      }
