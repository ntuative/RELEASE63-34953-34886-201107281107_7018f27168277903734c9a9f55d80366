package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_303:AvatarImageCache;
      
      private var var_648:int = 0;
      
      private var var_1836:int = 0;
      
      private var var_699:AvatarFigureContainer;
      
      private var var_649:Boolean;
      
      private var var_226:Array;
      
      private var var_609:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_699 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_699.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1540 = this.var_1379;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_57)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1540);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_699,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1540 < 3;
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_699,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_110)
               {
                  _loc17_ = 6;
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_539 = this.var_539 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_419:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1827:
                  case AvatarAction.const_2001:
                  case AvatarAction.const_2041:
                  case AvatarAction.const_1264:
                  case AvatarAction.const_1242:
                  case AvatarAction.const_1835:
                  case AvatarAction.const_1843:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1032);
         this.getCache().resetBodyPartCache(this.var_1032);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1539 = this._structure.sortActions(this.var_365);
         ...
         {
            this.var_913 = this._structure.getCanvasOffsets(this.var_1539,this._scale,this.var_102);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1539)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_454)
               {
                  this.var_1033 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_297)
               {
                  this.var_1033 = true;
               }
