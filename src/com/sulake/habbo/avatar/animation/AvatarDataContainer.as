package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1956:Number = 1.0;
      
      private var var_1954:Number = 1.0;
      
      private var var_1955:Number = 1.0;
      ...
      {
         super();
         this.var_1734 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2301 = parseInt(_loc2_,16);
         this.var_2300 = parseInt(_loc3_,16);
         ...
         this.var_897 = new ColorTransform(this.var_1956,this.var_1954,this.var_1955,this._alphaMultiplier);
         this.var_1166 = this.generatePaletteMapForGrayscale(this.var_2300,this.var_2301);
      }
      ...
      {
         return this.var_1166.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1166.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1166.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1166.getValue("alphas") as Array;
      }
