package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2401:String = "hd-99999-99999";
      ...
      private var var_909:PaletteManager;
      
      private var var_701:String;
      
      private var var_354:Map;
      
      private var var_264:AvatarAssetDownloadManager;
      
      private var var_2147:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_701 = RenderMode.const_1806;
         this.var_354 = new Map();
         this.var_124 = new Map();
         _loc4_ = new AvatarStructure(this,AvatarType.const_124,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_124.add(AvatarType.const_124,_loc4_);
         ...
         this.var_124.add(AvatarType.const_58,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_353 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_909 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_353.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_264)
         {
            this.var_264.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_353.init();
         this.var_909.init();
         _loc2_ = this.var_124.getValue(AvatarType.const_124) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_124.getValue(AvatarType.const_58) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_124.getValue(AvatarType.const_124) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1228,this.onFigureDataDownloadDone);
               if(this.var_264 == null)
               {
                  ...
                  this.var_264 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_264.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1004)
         {
            if(this.var_2944 && this.var_2945 && this.var_2946)
            {
               this.var_1004 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_264.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_264.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_124.getValue(AvatarType.const_124) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_264.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_2147)
         {
            this.var_2147 = new AvatarFigureContainer(this.const_2401);
         }
         this.var_264.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_2147,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc2_ in this.var_354.getKeys())
         {
            _loc3_ = this.var_354.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_353.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_2068)
         {
            _loc6_ = !this.var_353.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_353.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_124.getValue(AvatarType.const_58) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_354.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_353.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_124.getValue(AvatarType.const_58);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_354.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_354.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_124.getValue(AvatarType.const_124) as AvatarStructure;
      ...
      {
         return this.var_353 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            case AvatarType.const_124:
               _loc3_ = this.var_124.getValue(AvatarType.const_124) as AvatarStructure;
               break;
            case AvatarType.const_58:
               _loc3_ = this.var_124.getValue(AvatarType.const_58) as AvatarStructure;
               break;
            default:
