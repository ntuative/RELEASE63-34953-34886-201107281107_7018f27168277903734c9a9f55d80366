package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1228:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2972:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            ...
            {
               Core.error("Could not load avatar structure, got empty data from URL " + loaderStruct.assetLoader.url + " data length = " + data.length + ".",false,Core.const_234);
            }
            this.var_2173 = new XML(data);
         }
         catch(e:Error)
         {
         ...
         this.var_2972.appendXML(this.var_2173);
         dispatchEvent(new Event(AvatarStructureDownload.const_1228));
      }
      ...
      private function onDataFailed(param1:Event) : void
      {
         ...
         Core.error("Could not load avatar structure. Failed to get data from URL " + _loc3_,false,Core.const_234);
      }
   }
}
