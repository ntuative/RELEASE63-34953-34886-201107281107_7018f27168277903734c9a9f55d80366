package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_2175:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_4;
         this._assets = param4;
         this.var_916 = String(param1);
         this._revision = String(param2);
         this.var_1384 = param3 + this.var_916 + ".swf";
         this.var_1384 = this.var_1384.replace("%revision%",this._revision);
         var _loc5_:AssetLibraryCollection = this._assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_916 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_916);
            this._state = name_5;
         }
      }
      ...
      {
         this._state = var_2175;
         var _loc1_:URLRequest = new URLRequest(this.var_1384);
      ...
      {
         Core.error("Could not load avatar asset library " + this.var_916 + " from URL " + this.var_1384,false,Core.const_1234);
      }
      ...
      {
         var _loc1_:String = this.var_916;
