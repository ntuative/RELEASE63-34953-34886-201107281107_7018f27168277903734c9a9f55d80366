package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1637:String = "pixelbalance";
      
      private static const const_1632:String = "badges";
      
      private static const const_1633:String = "selectbadge";
      
      private static const const_1634:String = "inventory";
      
      private static const const_1631:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1635:String = "friendlist";
      
      private static const const_1630:String = "pet_inventory";
      
      private static const const_1636:String = "go_to_room";
      ...
      private var var_2056:IHabboToolbar;
      ...
      private var var_578:HabboNotificationViewManager;
      
      private var var_259:HabboAlertDialogManager;
      
      private var var_869:ParkBusDialogManager;
      
      private var var_2762:Boolean;
      
      private var var_1078:ClubGiftNotification;
      
      private var var_1080:ClubEndingNotification;
      
      private var var_1079:ClubPromoNotification;
      
      private var var_3107:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1077 = new Map();
         this.var_2055 = false;
         this.var_3107 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1077);
         }
         var _loc6_:Map = this.var_1077["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1077["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         return this.var_1322.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1322.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_259 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      {
         this.var_2056 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_578 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_2056,this.var_1077["styles"],this.var_1077["view"]);
         ...
         registerUpdateReceiver(this.var_578,1);
         registerUpdateReceiver(this,2);
         this.var_430.events.addEventListener(BadgeImageReadyEvent.const_219,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_430.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1337,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1337,null);
            }
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_430.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_63)
               {
                  _loc7_ = this.var_430.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_430.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1894,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_63:
               ...
               break;
            case CatalogPageMessageProductData.const_191:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1175)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1792,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1079 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1080 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_578.isSpaceAvailable() && this.var_1322.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_578.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1630:
               if(this.var_12 != null && this.var_12.hasRoomSession)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_134);
               }
               break;
            case const_1631:
               break;
      ...
      {
         if(param1 != null && this.var_578 != null)
         {
            this.var_578.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_259 == null)
         {
            return;
         }
         this.var_259.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_259.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_259.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_259.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_259.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_961.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_62);
            if(_loc6_ != null)
            {
      ...
      {
         if(param2.type == WindowEvent.const_156 || param2.type == WindowEvent.const_679)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1078 && this.var_1078.visible)
         {
            return;
         }
         this.var_1078 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_2056);
      }
