package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_656:int = 70;
      
      public static const const_1842:int = 5;
      
      private static const name_4:int = 0;
      
      private static const const_539:int = 1;
      ...
      private var var_256:HabboNotificationItem;
      
      private var var_1942:Boolean = false;
      
      private var var_1367:Map;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1943 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1943 = 15;
         }
         this.var_1941 = this._window.height;
         this.var_1554 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_256.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_539:
               ...
               _loc2_ = Number(this.var_1278) / Number(this.var_1043["time_fade_in"]);
               if(this.var_1278 > int(this.var_1043["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1086:
               ...
               if(this.var_1553 > int(this.var_1043["time_display"]) && !this.var_1942)
               {
                  this.startFadeOut();
               }
               break;
            case const_1087:
               ...
               _loc3_ = 1 - Number(this.var_1279) / Number(this.var_1043["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1279 > int(this.var_1043["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1943;
         if(this._window.height < this.var_1941)
         {
            this._window.height = this.var_1941;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1842;
         this._window.y = this.var_1554;
      }
