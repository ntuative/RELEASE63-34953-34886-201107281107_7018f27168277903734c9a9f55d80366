package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2110:int = 0;
      
      private const const_2104:int = 1;
      
      private const const_2107:int = 2;
      
      private const const_2108:int = 3;
      
      private const const_2105:int = 4;
      
      private const const_2376:int = 0;
      ...
      private const const_2106:String = "deco_img";
      
      private const const_2109:String = "dialog_bg";
      ...
      private const const_2380:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1468 = this.var_158.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1468 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1470.length)
         {
            _loc2_ = this.var_1470.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_158 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_868,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_829,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_589:
               _loc2_ = this.const_2110;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_829:
               ...
               if(_loc5_)
               {
                  if(_loc4_ && _loc4_ != "")
                  {
                     _loc2_ = this.const_2108;
                     var_73.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc4_);
                  }
                  else
                  {
                     _loc2_ = this.const_2107;
                  }
               }
               else
               {
                  _loc2_ = this.const_2105;
               }
               this._shareId = null;
               this.var_1467 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_868:
         ...
         if(this._window && (this.var_1469 != _loc2_ || _loc3_ != this.var_196))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1469)
            {
               ...
               case this.const_2104:
                  if(this.var_438 == this.const_2376)
                  {
                  ...
                  else if(this.var_438 == this.const_2375)
                  {
                  ...
                  else if(this.var_438 == this.const_2372)
                  {
                  ...
                  else if(this.var_438 == this.const_2379)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_438 == this.const_2374)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_196,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_438 == this.const_2373)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2378.replace("%campaign%",this.var_196);
            this.setDecoImage(_loc5_,this.const_2109);
            _loc2_ = _loc2_.replace("%campaign%",this.var_196);
            this.setDecoImage(_loc2_,this.const_2106);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_1021);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_186);
         ...
         if(this.var_12)
         {
            if(this.var_1467 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1467 == 1 ? "null" : InventoryCategory.const_134);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "", param4:int = 0) : void
      {
         ...
         if(messageListener != null)
         {
            _loc5_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_914,"ViralGift",param1,param2,param3,param4);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1470.push(new ImageDownloader(this,_assets,this.var_196,this.var_1468,param1,param2));
            return;
         }
