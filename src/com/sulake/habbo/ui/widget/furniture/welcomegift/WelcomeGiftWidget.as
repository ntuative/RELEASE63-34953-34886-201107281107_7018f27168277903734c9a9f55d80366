package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_1118:String = "welcome_gift_email_verified";
      
      private const const_1655:String = "welcome_gift_email_change";
      
      private const const_2400:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1336)
         {
            this.setViewState(this.const_1118);
         }
         else
         {
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_708:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1086;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1086);
               break;
            case this.const_1118:
            ...
            case this.const_1655:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1086);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1623;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1655);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_902,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1336 ? this.const_1118 : this.const_708);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1622 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1622));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_611,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_819,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_611,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_819,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_611:
               this.var_1623 = param1.email;
               this.var_1336 = param1.isVerified;
               this.var_1086 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1623 = this.var_1622;
            this.setViewState(this.const_708);
         }
         else
         {
            if(param1.result == this.const_2400)
            {
               this.var_1086 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1622);
