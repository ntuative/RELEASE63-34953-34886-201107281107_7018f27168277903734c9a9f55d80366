package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1431:uint = 4281149991;
      ...
      protected static const const_1432:uint = 9552639;
      ...
      private static const const_1509:int = 25;
      
      private static const const_1065:int = 3;
      
      protected static var var_1163:Boolean = false;
      ...
      protected var var_1908:Boolean;
      
      protected var var_2273:FixedSizeStack;
      ...
      protected var var_3066:int = 3000;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_2327 = param4;
         param1.var_2272 = param6;
         ...
         if(param1.var_1155)
         {
            if(!param1.var_511)
            {
               param1.var_511 = new Timer(param1.var_3066,1);
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_498));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1719)
         {
            ...
            this._blend = 1 - this.var_1716 / Number(this.var_3067);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1908 || this.var_1864)
         {
            _loc4_ = -this.var_192.height;
            if(this.var_1718 == RoomObjectTypeEnum.const_136 || this.var_1718 == RoomObjectTypeEnum.const_575)
            {
            ...
            this.var_2273.addValue(_loc5_);
            _loc6_ = this.var_2273.getMax();
            if(_loc6_ < this.var_2274 - const_1065)
            {
               _loc6_ = this.var_2274 - const_1065;
            }
