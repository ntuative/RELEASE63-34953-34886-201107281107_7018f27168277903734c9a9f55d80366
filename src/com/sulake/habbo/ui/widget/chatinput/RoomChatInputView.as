package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1544:int = 250;
      
      private static const const_1542:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1543:String = "${widgets.chatinput.say}";
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1271 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2602 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2603 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_393 = new Timer(1000,1);
         this.var_393.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_393.reset();
            this.var_393.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_393 = null;
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1542 = this._window.findChildByName("block_text");
         this.var_1929.caption = const_1543;
         ...
         this.var_26.addEventListener(WindowEvent.const_118,this.onInputChanged);
         ...
         this._window.addEventListener(WindowEvent.const_500,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1544 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1542);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_26 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1271 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_26.text = "";
                  this.var_683 = "";
               }
      ...
      private function method_6(param1:Boolean) : void
      {
         if(this._button)
         {
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_683.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_682);
