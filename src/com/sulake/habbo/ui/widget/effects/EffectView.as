package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2367:int = 1000;
      
      private var _widget:EffectsWidget;
      
      private var _window:IWindowContainer;
      
      private var var_110:IWidgetAvatarEffect;
      
      private var var_631:IWindow;
      
      private var var_331:Number;
      
      private var var_373:ITextWindow;
      
      private var var_218:Timer;
      
      private var var_632:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_110 = param2;
         this._widget = param1;
         this.var_218 = new Timer(this.const_2367);
         this.var_218.addEventListener(TimerEvent.TIMER,this.onUpdate);
         this.update();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_218.stop();
            this.var_218.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_218 = null;
         }
         this._widget = null;
         this.var_110 = null;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_110.isActive)
         {
            _loc2_ = this.var_110.secondsLeft / Number(this.var_110.duration);
            this.var_631.width = _loc2_ * this.var_331;
         }
         else
         {
            this.var_631.width = 0;
            this.var_218.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_373 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_373 == null)
            {
               return;
            }
         ...
         if(!this.var_110.isActive)
         {
            this.var_373.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         if(this.var_110.secondsLeft > 86400)
         {
            this.var_373.caption = "${widgets.memenu.effects.active.daysleft}";
            _loc1_ = this.var_373.text;
            _loc2_ = Math.floor(this.var_110.secondsLeft / 86400);
            _loc1_ = _loc1_.replace("%days_left%",_loc2_);
         }
         else
         {
            this.var_373.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_373.text;
            _loc3_ = this.var_110.secondsLeft;
      ...
      public function update() : void
      {
         ...
         this.var_373 = null;
         var _loc2_:String = "";
         if(this.var_110.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_110.isActive)
         {
         ...
         else
         {
            ...
            this.var_632 = this._window.findChildByName("effect_hilite");
            this.var_632.visible = false;
         }
         this.setTimeLeft();
         this.var_631 = this._window.findChildByName("loader_bar");
         if(this.var_631 != null)
         {
            this.var_331 = this.var_631.width;
            this.var_218.start();
            this.onUpdate();
         }
         if(this.var_110.icon)
         {
            this.setElementBitmap("effect_icon",this.var_110.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_110.type,this.var_110.isInUse);
         }
      }
