package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1015:TagListRenderer;
      
      private var var_154:IBorderWindow;
      
      private var var_2759:int;
      
      private var var_2760:Boolean = true;
      
      private const const_1115:int = 5;
      
      private const const_2393:int = 3;
      
      private const const_1628:int = 11184810;
      
      private const const_1629:int = 16777215;
      
      private const const_2392:int = 2000;
      
      private const const_2394:int = 50;
      
      private const const_2391:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1015 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2760 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            _loc4_.addEventListener(WindowEvent.const_42,this.onButtonResized);
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_154.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_154.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_154.x = _loc5_.left - this.var_154.width;
         this.var_154.y = _loc5_.top + (_loc5_.height - this.var_154.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_154.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_154.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_154.x = _loc7_.left - this.var_154.width;
         this.var_154.y = _loc7_.top + (_loc7_.height - this.var_154.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_154 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_154 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1115;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1628;
            }
            else
            {
               _loc5_.textColor = this.const_1629;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1115,this.const_2394);
         _loc5_.height = Math.max(_loc5_.height,this.const_2391);
         _loc3_.height = _loc5_.height + this.const_2393;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_327,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_327,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1015.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2759 > this.const_2392 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2759 = _loc6_;
               _loc3_.textColor = this.const_1629;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1628;
         }
      }
