package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_269 = this.var_49.findChildByTag("catalog");
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               break;
            case "RoomWidgetFriendRequestUpdateEvent":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1399 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_557 && param1.isRoomOwner)
         {
         ...
         this.showButton("RoomWidgetFriendRequestUpdateEvent",_loc6_);
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1260.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
