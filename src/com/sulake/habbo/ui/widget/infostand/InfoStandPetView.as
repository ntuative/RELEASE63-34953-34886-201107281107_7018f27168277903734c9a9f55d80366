package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1694:int = 162;
      
      private static const const_1698:int = 16;
      
      private static const const_720:int = 4;
      
      private static const const_1703:uint = 14342874;
      
      private static const const_1701:uint = 3815994;
      
      private static const const_1697:uint = 2085362;
      
      private static const const_1702:uint = 39616;
      
      private static const const_1693:uint = 10513106;
      
      private static const const_1692:uint = 8734654;
      
      private static const const_1696:uint = 9094430;
      
      private static const const_1700:uint = 6200576;
      
      private static const const_1695:String = "happiness";
      
      private static const const_1691:String = "experience";
      
      private static const const_1690:String = "energy";
      
      private static const const_1699:int = 250;
      ...
      private var var_231:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1695,param1.nutrition,param1.nutritionMax,const_1702,const_1697);
         this.updateStateElement(const_1691,param1.experience,param1.experienceMax,const_1692,const_1693);
         this.updateStateElement(const_1690,param1.energy,param1.energyMax,const_1700,const_1696);
         ...
         if(this.var_231 && this.var_231.isVisible() && param1.isOwnPet)
         {
            this.var_231.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_231.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1694,const_1698,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1703);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1701);
      ...
      private function openTrainView() : void
      {
         if(this.var_231 == null)
         {
            this.var_231 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_573) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_231.showWindow(true);
            this.var_231.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for each(_loc10_ in _loc4_)
         {
            ...
            _loc10_.addEventListener(WindowEvent.const_42,this.onButtonResized);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_231 && this.var_231.getPetId() == this.var_573)
               {
                  this.var_231.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1774,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_424,this._widget.petData.ownerId);
