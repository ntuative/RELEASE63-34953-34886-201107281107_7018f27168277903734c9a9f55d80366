package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_875:String = "PLSV_ADD_SONGS";
      
      public static const const_1259:String = "PLSV_START_PLAYBACK";
      
      public static const const_596:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_596)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_472[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_472[const_875];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_472.add(const_596,_loc1_);
