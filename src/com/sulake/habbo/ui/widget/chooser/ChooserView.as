package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_2092:uint = 0;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_2092) : uint(this.const_2093);
      ...
      private function highlightItem(param1:int) : void
      {
         ...
         if(this.var_965 != -1)
         {
            ...
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_965 % 2) ? uint(this.const_2092) : uint(this.const_2093);
            }
         }
