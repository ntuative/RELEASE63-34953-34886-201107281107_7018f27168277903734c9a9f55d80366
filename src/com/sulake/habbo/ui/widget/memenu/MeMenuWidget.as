package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_578:String = "me_menu_my_clothes_view";
      
      public static const const_1388:String = "me_menu_dance_moves_view";
      
      public static const const_873:String = "me_menu_settings_view";
      
      public static const const_783:String = "me_menu_sound_settings";
      
      private static const const_1154:Point = new Point(95,440);
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2971 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_2152 = this._config.getBoolean("menu.own_avatar.enabled",false);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_803,this.onWaveEvent);
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_1034,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_751,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_801,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1257,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1193,this.onHideAvatarEditor);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_173,this.onAvatarDeselected);
         ...
         param1.addEventListener(RoomWidgetSettingsUpdateEvent.const_446,this.onSettingsUpdate);
         param1.addEventListener(RoomWidgetTutorialEvent.const_139,this.onTutorialEvent);
         param1.addEventListener(RoomWidgetTutorialEvent.const_672,this.onTutorialEvent);
         param1.addEventListener(RoomWidgetPurseUpdateEvent.const_138,this.onCreditBalance);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_803,this.onWaveEvent);
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_1034,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_751,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_801,this.onToolbarClicked);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_173,this.onAvatarDeselected);
         param1.removeEventListener(RoomWidgetHabboClubUpdateEvent.const_275,this.onHabboClubEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1257,this.onHideAvatarEditor);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1193,this.onAvatarEditorClosed);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_116,this.onUserInfo);
         param1.removeEventListener(RoomWidgetSettingsUpdateEvent.const_446,this.onSettingsUpdate);
         param1.removeEventListener(RoomWidgetTutorialEvent.const_672,this.onTutorialEvent);
         param1.removeEventListener(RoomWidgetTutorialEvent.const_139,this.onTutorialEvent);
         param1.removeEventListener(RoomWidgetPurseUpdateEvent.const_138,this.onCreditBalance);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_599 && this.var_54.window.name == const_578))
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_947);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_54.window.name == const_783)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_672:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_599 + " view: " + this.var_54.window.name);
               if(this.var_599 != true || this.var_54.window.name != const_188)
               {
                  return;
               }
               (this.var_54 as MeMenuMainView).setIconAssets("clothes_icon",const_188,"clothes_highlighter_blue");
               break;
            case RoomWidgetTutorialEvent.const_139:
               this.hide();
         }
      }
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_599)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_1030);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      {
         if(this.var_54 != null && this.var_54.window.name != const_578)
         {
            this.hide();
         }
      }
      ...
      {
         var _loc2_:* = param1.daysLeft != this.var_1673;
         this.var_1673 = param1.daysLeft;
         this.var_2969 = param1.periodsLeft;
         this.var_3117 = param1.pastPeriods;
         this.var_2968 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_2167);
         this.var_2167 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_54 != null)
            {
      ...
      private function onCreditBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         this.var_2970 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",this.var_2970.toString());
      }
