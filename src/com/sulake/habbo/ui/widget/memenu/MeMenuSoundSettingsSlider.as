package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1964:MeMenuSoundSettingsView;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1964.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_841 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_841.width,this.var_841.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_841,this.var_841.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_840 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_840.width,this.var_840.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_840,this.var_840.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1949 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
