package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_242.events.addEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_242.events.addEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_219,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               ...
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_112,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_219,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            ...
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_112,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_629.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_629.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_242 != null)
         {
            this.var_242.events.removeEventListener(NowPlayingEvent.const_103,this.onNowPlayingChanged);
            this.var_242.events.removeEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
            this.var_242 = null;
         }
         this.var_1154 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_493);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_845);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_424);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_1027);
         _loc1_.push(RoomWidgetFurniActionMessage.const_917);
         _loc1_.push(RoomWidgetFurniActionMessage.const_949);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1252);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_1000);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_792);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_788);
         _loc1_.push(RoomWidgetUserActionMessage.const_507);
         _loc1_.push(RoomWidgetUserActionMessage.const_530);
         _loc1_.push(RoomWidgetUserActionMessage.const_549);
         _loc1_.push(RoomWidgetUserActionMessage.const_1804);
         _loc1_.push(RoomWidgetPetCommandMessage.const_617);
         _loc1_.push(RoomWidgetPetCommandMessage.const_1001);
         _loc1_.push(RoomWidgetUserActionMessage.const_495);
         _loc1_.push(RoomWidgetUserActionMessage.const_248);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_964);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_507)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_248 || param1.type == RoomWidgetUserActionMessage.const_495 || param1.type == RoomWidgetUserActionMessage.const_549)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_493:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_845:
            ...
            case RoomWidgetUserActionMessage.const_613:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1192,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_587:
               ...
               break;
            case RoomWidgetUserActionMessage.const_424:
            ...
            case RoomWidgetUserActionMessage.const_549:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1027:
            ...
            case RoomWidgetFurniActionMessage.const_257:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_917:
            ...
            case RoomWidgetFurniActionMessage.const_949:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1252:
               ...
               break;
            case RoomWidgetUserActionMessage.const_248:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_1000:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_792:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_788:
               ...
               break;
            case RoomWidgetUserActionMessage.const_507:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_249);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_360);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_441) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_441);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_922) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1399;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_249);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1382);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1217);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_557)
                  {
                     _loc30_ = this.var_242.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_439) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_439.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_242.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_216)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_136)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_575)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_322);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_162)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_889);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_817;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_768;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_2060);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_629.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_629.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_889);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_242 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_242.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_438,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_242 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_409,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
