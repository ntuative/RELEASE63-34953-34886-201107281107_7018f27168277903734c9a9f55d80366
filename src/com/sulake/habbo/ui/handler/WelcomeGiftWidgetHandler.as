package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_813 = [];
         this.var_813.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_813.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_813)
         {
            return;
         }
         for each(_loc1_ in this.var_813)
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetFurniActionMessage.const_902);
         _loc1_.push(RoomWidgetChangeEmailMessage.const_1005);
         return _loc1_;
      }
