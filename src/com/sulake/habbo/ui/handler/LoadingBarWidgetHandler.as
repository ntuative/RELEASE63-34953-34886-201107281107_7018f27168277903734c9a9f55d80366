package com.sulake.habbo.ui.handler
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(InterstitialEvent.const_533);
         _loc1_.push(InterstitialEvent.const_550);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_109);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_344);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case InterstitialEvent.const_533:
               ...
               break;
            case InterstitialEvent.const_550:
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_109:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_344:
               this._container.events.dispatchEvent(param1);
         }
      }
