package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1491:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2180:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2180 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1491;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1113 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_290 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_2180.prepare(this.var_1113);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1270,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1380,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_1004,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_932,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1004,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_932,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1682 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1682.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2181 == -1 ? 0 : int(this.var_16.height - this.var_2181);
         var _loc4_:int = this.var_2179 == -1 ? 0 : int(this.var_16.width - this.var_2179);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_290.y = Util.getLowestPoint(this.var_16.content);
         this.var_290.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1230,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1004,false);
         ...
         this.var_2181 = this.var_16.height;
         this.var_2179 = this.var_16.width;
