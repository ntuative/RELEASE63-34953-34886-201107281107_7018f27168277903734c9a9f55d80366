package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1743:AvatarSearchResults;
      ...
      {
         this.var_2308 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_119 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1743 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_622.stop();
            this.var_622.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_622 = null;
         }
         ...
         if(this.var_160)
         {
            this.var_160.release(new IIDHabboMessenger());
            this.var_160 = null;
         }
         if(this.var_164)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1744 = new OpenedToWebPopup(this);
         }
         this.var_1744.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_117);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_354,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_613.createAvatarImage(param1,AvatarScaleType.const_110,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_160 = param2 as IHabboMessenger;
      ...
      {
         this.var_993 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_1185,this.getText("friendlist.friends")));
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_429,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_622)
         {
            this.var_622 = new Timer(120000);
            this.var_622.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_622.start();
         }
         ...
         {
            _loc5_ = this.var_119.findCategory(FriendCategory.const_429);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_494.findTab(FriendListTab.const_88).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_494.findTab(FriendListTab.const_88);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1743.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_494.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_494.findTab(FriendListTab.const_88);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_769 || !this.var_121)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_769.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_36))
         {
            _loc2_ = this.var_121.vipLimit;
         }
         else if(this.var_769.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_34))
         {
