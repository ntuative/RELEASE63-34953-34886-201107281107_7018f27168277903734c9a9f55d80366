package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2111:String = "no_reqs_info";
      ...
      private var var_1814:IContainerButtonWindow;
      
      private var var_1815:IContainerButtonWindow;
      ...
      {
         this.var_1814 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1815 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1815.procedure = this.onDismissAllButtonClick;
         this.var_1814.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_193)
         {
         ...
         else if(param1.state == FriendRequest.const_420)
         {
         ...
         else if(param1.state == FriendRequest.const_1377)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_420;
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_420 && _loc2_.state != FriendRequest.const_432)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1814,_loc1_);
         this.setEnabled(this.var_1815,_loc1_);
      }
