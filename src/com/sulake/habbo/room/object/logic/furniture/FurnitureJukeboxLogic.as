package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_599,RoomObjectFurnitureActionEvent.const_605,RoomObjectFurnitureActionEvent.const_561,RoomObjectFurnitureActionEvent.const_597,RoomObjectWidgetRequestEvent.const_163];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_763) == 1)
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_441,RoomWidgetInfostandExtraParamEnum.const_557);
