package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1446:uint = 16777215;
      
      private var var_1754:int = 255;
      
      private var var_1174:uint = 16777215;
      
      private var var_1756:int = 255;
      
      private var var_1175:int = 0;
      
      private var var_1755:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_568,RoomObjectMouseEvent.const_171];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_781,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_1015,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_935,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1016,1);
         ...
         if(this.var_1445)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_781,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1322,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1175)
         {
            ...
            if(_loc2_ - this.var_1175 >= this.var_1755)
            {
               _loc3_ = this.var_1174;
               _loc4_ = this.var_1756;
               this.var_1175 = 0;
            }
            else
            {
               _loc7_ = this.var_1446 >> 16 & 255;
               _loc8_ = this.var_1446 >> 8 & 255;
               _loc9_ = this.var_1446 & 255;
               _loc10_ = this.var_1174 >> 16 & 255;
               _loc11_ = this.var_1174 >> 8 & 255;
               _loc12_ = this.var_1174 & 255;
               _loc13_ = (_loc2_ - this.var_1175) / this.var_1755;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1754 + (this.var_1756 - this.var_1754) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_1015,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_851:
               param2.setString(RoomObjectVariableEnum.const_215,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_950:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_642:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_289)
               {
                  _loc5_ = "null";
               }
               this.var_577.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_780:
               _loc4_ = this.var_577.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_577.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1241,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1254:
               param2.setNumber(RoomObjectVariableEnum.const_935,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1412:
               param2.setNumber(RoomObjectVariableEnum.const_1016,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_690:
               param2.setNumber(RoomObjectVariableEnum.const_1304,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1343:
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_177:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1295,int(param1.bgOnly));
         this.var_1446 = this._color;
         this.var_1754 = this.var_1757;
         this.var_1174 = _loc3_;
         this.var_1756 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_510,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1869,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1893,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_2016,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_510,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_306 || _loc12_ == RoomPlaneData.const_398)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
