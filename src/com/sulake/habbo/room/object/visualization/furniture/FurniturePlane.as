package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_806:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_806 = new Vector3d();
         this.var_806.assign(param2);
         this.var_805 = new Vector3d();
         this.var_805.assign(param3);
      ...
      {
         if(param1 != this.var_2467)
         {
            if(!param1)
            {
               this.var_327.assign(this.var_806);
               this.var_328.assign(this.var_805);
            }
            else
            {
               this.var_327.assign(this.var_806);
               this.var_327.mul(this.var_805.length / this.var_806.length);
               this.var_328.assign(this.var_805);
               this.var_328.mul(this.var_806.length / this.var_805.length);
            }
            this.var_1852 = -1;
            this.var_1497 = this.var_1497 - 1;
      ...
      private function needsNewTexture(param1:IRoomGeometry) : Boolean
      {
         ...
         if(this.var_217 > 0 && this._height > 0)
         {
            if(_loc3_ == null)
            {
               return true;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_105 == null && this.var_1181 != null || this.var_327 == null || this.var_328 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1852)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1497 || _loc4_.y != this.var_2466 || _loc4_.z != this.var_2468 || param1.scale != this.var_2043))
            {
               this.var_1497 = _loc4_.x;
               this.var_2466 = _loc4_.y;
               this.var_2468 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1181);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_173.z - _loc7_,this.var_128.z - _loc7_,this.var_97.z - _loc7_,this.var_127.z - _loc7_);
               this.var_2360 = _loc8_;
