package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1549:String = "branded_image";
      
      private static const const_1551:int = 0;
      
      private static const const_1548:int = 1;
      
      private static const const_1550:int = 2;
      
      private static const const_1552:int = 3;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1724 = _loc4_.getNumber(RoomObjectVariableEnum.const_536);
                  this.var_1725 = _loc4_.getNumber(RoomObjectVariableEnum.const_677);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_593);
               }
            }
         }
         if(!this.var_1431)
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_651);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1549)
         {
