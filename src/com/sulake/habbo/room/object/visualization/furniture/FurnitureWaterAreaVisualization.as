package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1452:String = "shore";
      ...
      {
         if(this.var_2319 == param1 && this.var_2318 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1452)
            {
               this.var_1766 = _loc2_;
               this.var_2319 = param1;
               this.var_2318 = direction;
               return this.var_1766;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1179.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_526 + 2;
         var _loc4_:int = this.var_626 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1765 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_441.length)
         {
            if(this.var_441[_loc5_] == true)
            {
               this.var_1765 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_526 == 0 || this.var_626 == 0)
         {
            ...
            this.var_526 = _loc2_.getNumber(RoomObjectVariableEnum.const_316);
            this.var_626 = _loc2_.getNumber(RoomObjectVariableEnum.const_367);
         }
         this.var_441 = [];
         this.var_627 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_526 * 2 + this.var_626 * 2)
         {
            this.var_441.push(false);
            this.var_627.push(ShoreMaskCreatorUtility.const_85);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_526 + 2;
         var _loc2_:int = this.var_626 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_79,getSize(param3),this.var_441,this.var_627,assetCollection);
      }
