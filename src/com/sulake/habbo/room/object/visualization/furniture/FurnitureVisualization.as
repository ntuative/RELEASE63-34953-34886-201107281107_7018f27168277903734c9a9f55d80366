package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_2848:Number = NaN;
      ...
      private var var_2846:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1635 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1635;
            this.var_1635 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_663 != spriteCount)
         {
            createSprites(this.var_663);
         }
         if(param2)
         {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               if(param2 != this.var_1636)
               {
                  ...
                  _loc4_.color = this.getSpriteColor(param1,param2,this.var_2843);
               ...
               _loc4_.clickHandling = this.var_2509;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_515 != _loc3_.getUpdateID() || param1 != var_103 || param2 != this.var_2848)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2843 = _loc3_.getNumber(RoomObjectVariableEnum.const_272);
            ...
            this.var_2509 = this.var_1347 != null;
            this.var_2847 = _loc3_.getNumber(RoomObjectVariableEnum.const_1002);
      ...
      {
         if(this.var_2844 != param2 || this.var_2846 != param1)
         {
            this.var_1093 = [];
            this.var_1092 = [];
            this.var_886 = [];
            ...
            this.var_2845 = this.getSize(param1);
      ...
      {
         this.var_663 = param1;
         this.var_1636 = this.var_663 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_663.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1093[param2];
         var _loc4_:Boolean = this.var_1092[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2845;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1636)
            {
               _loc6_ = FurnitureVisualizationData.const_663[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_1093[param2] = _loc3_;
            this.var_1092[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_883[param3] != null && !this.var_2088)
         {
            return this.var_883[param3];
         }
         if(this._data == null)
         {
         ...
         this.var_883[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteColor(param1:int, param2:int, param3:int) : int
      {
         if(this.var_881[param2] != null)
         {
            return this.var_881[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2847 * (param1 / 2));
      }
