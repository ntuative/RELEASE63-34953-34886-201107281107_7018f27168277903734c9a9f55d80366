package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1218[param2];
         var _loc4_:int = this.var_1219[param2];
         var _loc5_:int = this.var_1220[param2];
         var _loc6_:Number = this.var_1217[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1063;
         }
         ...
         this.var_1218[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1217[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1218.push(Math.random() * _loc2_ * 1.5);
         this.var_1218.push(Math.random() * _loc2_ * 1.5);
         this.var_1219 = new Array();
         this.var_1219.push(1);
         this.var_1219.push(-1);
         this.var_1220 = new Array();
         this.var_1220.push(const_1497);
         this.var_1220.push(const_1498);
         this.var_1217 = new Array();
         this.var_1217.push(this.getRandomAmplitudeFactor());
         this.var_1217.push(this.getRandomAmplitudeFactor());
      }
