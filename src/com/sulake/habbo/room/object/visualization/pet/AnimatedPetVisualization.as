package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1593:String = "head";
      
      private static const const_698:int = 1;
      
      private static const const_1099:int = 1000;
      
      private static const const_1592:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1592) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_403 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2691)
            {
               this.var_2691 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_280);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_161);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_280);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_2116 = _loc3_.getNumber(RoomObjectVariableEnum.const_276) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_214);
            if(!isNaN(_loc8_))
            {
               this.var_2013 = _loc8_;
            }
            else
            {
               this.var_2013 = direction;
            }
            this.var_1461 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2323 = _loc3_.getNumber(RoomObjectVariableEnum.const_410);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_1020);
            if(_loc9_ != this.var_2012)
            {
               this.var_2012 = _loc9_;
               this.var_2690 = this.var_2012.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_403 != null)
         {
            ...
            if(this.var_1461 > 0)
            {
               ...
               if(_loc2_ < const_1099)
               {
                  this.var_403.alpha = int(Math.sin(_loc2_ / const_1099 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_403.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_403.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_698;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2690);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_698)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_698))
            {
               if(param2 >= FurnitureVisualizationData.const_663.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_663[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2013);
         }
         return direction;
      }
      ...
      {
         if(this.var_1057[param1] == null)
         {
            if(this._animationData.getTag(var_103,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1593)
            {
               this.var_1057[param1] = true;
            }
            else
            {
               this.var_1057[param1] = false;
            }
         }
         return this.var_1057[param1];
      }
   }
}
