package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1757:int = 16777215;
      
      public static const const_1989:int = 13421772;
      
      private static const const_1111:int = 16777215;
      
      private static const const_1110:int = 13421772;
      
      private static const const_1109:int = 10066329;
      
      private static const const_1108:int = 10066329;
      
      public static const const_2017:int = 16777215;
      
      public static const const_1899:int = 13421772;
      
      public static const const_1860:int = 10066329;
      ...
      private var var_863:Rectangle = null;
      
      private var var_577:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_1002:Number = NaN;
      
      private var var_1507:Number = NaN;
      
      private var var_2751:Number = NaN;
      
      private var var_2044:String = null;
      
      private var var_1315:uint = 16777215;
      ...
      private const const_2390:int = 250;
      
      private var var_1852:int = -1;
      
      private var var_1497:Number = 0.0;
      
      private var var_2466:Number = 0.0;
      
      private var var_2468:Number = 0.0;
      
      private var var_2043:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_577 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_863 = super.boundingRectangle;
         }
         return new Rectangle(this.var_863.x,this.var_863.y,this.var_863.width,this.var_863.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1002))
         {
            this._planeParser.floorThicknessMultiplier = this.var_1002;
         }
         if(!isNaN(this.var_1507))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1507;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1416);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_306)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_398)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_2017;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1899;
               }
               else
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1888)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_76,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_398)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2390 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_408.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2045)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2750 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2749 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2748 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1852)
         {
            this.var_1852 = param1.updateId;
            this.var_863 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1497 || _loc3_.y != this.var_2466 || _loc3_.z != this.var_2468 || param1.scale != this.var_2043))
            {
               this.var_1497 = _loc3_.x;
               this.var_2466 = _loc3_.y;
               this.var_2468 = _loc3_.z;
               this.var_2043 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1241);
            if(_loc3_ != this.var_2044)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2044 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_1015));
            if(_loc4_ != this.var_1315)
            {
               this.var_1315 = _loc4_;
               this.var_2750 = this.var_1315 & 255;
               this.var_2749 = this.var_1315 >> 8 & 255;
               this.var_2748 = this.var_1315 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1295));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_148 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_228);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_935));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1016));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_148 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1304);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1218);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_1002 || _loc3_ != this.var_1507))
            {
               this.var_1002 = _loc2_;
               this.var_1507 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_148 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1322);
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1314;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_577.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_577.maskCount)
         {
            _loc10_ = this.var_577.getMaskType(_loc8_);
            _loc11_ = this.var_577.getMaskLocation(_loc8_);
            _loc12_ = this.var_577.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_76 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_289)
                              {
