package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_700:String = "Navigation";
      
      private static const const_699:String = "Friend Bar";
      
      private static const const_1599:String = "go.friendbar";
      
      private static const const_1597:String = "chat_btn_click";
      
      private static const const_1598:String = "find_friends_btn_click";
      
      private static const const_1101:String = "Toolbar";
      
      private static const const_1100:String = "open";
      
      private static const const_1102:String = "close";
      
      private static const const_1601:String = "FRIENDLIST";
      
      private static const const_1600:String = "MESSENGER";
       
      
      private var var_1063:IHabboConfigurationManager;
      
      private var var_95:IHabboCommunicationManager;
      
      private var var_89:IHabboFriendList;
      
      private var var_225:IHabboMessenger;
      
      private var var_405:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1063)
            {
               this.var_1063.release(new IIDHabboConfigurationManager());
               this.var_1063 = null;
            }
            if(this.var_95)
            {
            ...
            if(this.var_89)
            {
               if(!this.var_89.disposed)
               {
                  this.var_89.events.removeEventListener(FriendRequestEvent.const_60,this.onFriendRequestEvent);
                  this.var_89.events.removeEventListener(FriendRequestEvent.const_224,this.onFriendRequestEvent);
               }
               this.var_89.release(new IIDHabboFriendList());
               this.var_89 = null;
            }
            if(this.var_225)
            {
               this.var_225.release(new IIDHabboMessenger());
               this.var_225 = null;
            }
            if(this.var_405)
            {
               this.var_405.release(new IIDHabboEventStream());
               this.var_405 = null;
            }
            this.var_116 = null;
      ...
      {
         return this.var_342.getValue(param1);
      }
      ...
      {
         var _loc3_:int = this.var_116.indexOf(param1);
         if(_loc3_ > -1 && _loc3_ != param2)
         {
            this.var_116.splice(_loc3_,1);
            this.var_116.splice(param2,0,param1);
      ...
      public function acceptFriendRequest(param1:int) : void
      {
         ...
         if(this.var_89)
         {
            if(!this.var_89.disposed)
            {
               this.var_89.acceptFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_121 = [];
         this.var_89.acceptAllFriendRequests();
      ...
      public function declineFriendRequest(param1:int) : void
      {
         ...
         if(this.var_89)
         {
            if(!this.var_89.disposed)
            {
               this.var_89.declineFriendRequest(param1);
            }
         }
      }
      ...
      {
         this.var_121 = [];
         this.var_89.declineAllFriendRequests();
         events.dispatchEvent(new FriendRequestUpdateEvent());
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_700,const_699,const_1599));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_225)
         {
            this.var_225.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_95)
            {
               this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_700,const_699,const_1597));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_700,const_699,const_1598));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_89)
         {
            if(!this.var_89.disposed)
            {
               if(!this.var_89.isOpen())
               {
                  if(this.var_121.length > 0)
                  {
                     this.var_89.openFriendRequests();
                  }
                  else
                  {
                     this.var_89.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_89.mainWindow;
               ...
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1101,const_1601,!!this.var_89.isOpen() ? const_1100 : const_1102));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_225)
         {
            ...
            {
               this.var_225.toggleMessenger();
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1101,const_1600,!!this.var_225.isOpen() ? const_1100 : const_1102));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_405)
         {
            if(!this.var_405.disposed)
            {
               this.var_405.visible = !this.var_405.visible;
            }
         }
      }
      ...
      public function refreshOfflineStream() : void
      {
         if(this.var_405)
         {
            if(!this.var_405.disposed)
            {
               this.var_405.refreshEventStream();
            }
         }
      }
      ...
      {
         this.var_1063 = param2 as IHabboConfigurationManager;
         this.var_2706 = this.var_1063.getBoolean("friendbar.notifications.enabled",false);
         this.var_2030 = this.var_1063.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_225 = param2 as IHabboMessenger;
      }
      
      private function onOfflineStreamAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_405 = param2 as IHabboEventStream;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_89 = param2 as IHabboFriendList;
         this.var_89.events.addEventListener(FriendRequestEvent.const_60,this.onFriendRequestEvent);
         this.var_89.events.addEventListener(FriendRequestEvent.const_224,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_342.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_342.remove(_loc8_);
               this.var_116.splice(this.var_116.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_342.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_318)
            {
               ...
               this.var_116.splice(0,0,_loc3_);
               this.var_342.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_318)
            {
               if(this.var_342.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_116 = !!const_318 ? this.sortByNameAndOnlineStatus(this.var_116) : this.sortByName(this.var_116);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_856 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_225)
         {
            if(this.var_225.isOpen())
            {
               _loc4_ = this.var_225.method_8();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_856)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_856));
            this.makeNotification(String(this.var_856),FriendNotification.const_430,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_856 = _loc2_.senderId;
         if(this.var_225 && !this.var_225.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_856));
            this.makeNotification(String(this.var_856),FriendNotification.const_430,null,true,false);
         }
      }
