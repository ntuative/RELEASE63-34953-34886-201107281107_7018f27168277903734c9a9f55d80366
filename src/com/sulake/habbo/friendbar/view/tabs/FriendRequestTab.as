package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2075:String = "friend_request_tab_xml";
      ...
      private static const const_1076:uint = 16767334;
      ...
      public function FriendRequestTab()
      {
         ...
         if(_window)
         {
            _window.findChildByName(const_468).visible = false;
         }
      }
      ...
      public static function allocate(param1:FriendRequest) : FriendRequestTab
      {
         ...
         if(_loc2_.friend)
         {
            if(_loc2_.friend.figure != param1.figure)
            {
               ...
               _loc3_.bitmap = var_509.getAvatarFaceBitmap(param1.figure);
            }
         }
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2075).content as XML) as IWindowContainer;
         ...
         var _loc5_:IBubbleWindow = _loc1_.findChildByName(const_468) as IBubbleWindow;
         _loc1_.x = 0;
         _loc1_.y = 0;
         _loc1_.width = name_2;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_325,WindowStyle.const_106,WindowParam.const_30,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_395,WindowStyle.const_106,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2076:
                  var_361.acceptFriendRequest(var_168.id);
                  break;
               case const_1429:
                  if(selected)
                  {
                  ...
                  break;
               case const_1041:
                  var_361.declineFriendRequest(var_168.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1041)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1530;
            }
         }
      }
         ...
         if(!disposed)
         {
            if(friend)
            {
               if(friend.figure == param1.figure)
               {
                  ...
                  if(_loc3_)
                  {
                     _loc4_ = var_509.getAvatarFaceBitmap(param1.figure);
                     if(_loc4_)
                     {
