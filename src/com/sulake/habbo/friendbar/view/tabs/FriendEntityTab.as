package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1656:String = "entity_xml";
      
      private static const const_1658:String = "facebook_piece_xml";
      
      private static const const_1657:String = "controls_piece_xml";
      
      protected static const const_1045:String = "pieces";
      
      protected static const const_386:String = "icons";
      
      protected static const const_465:String = "header";
      
      protected static const const_1435:String = "facebook";
      
      protected static const const_1434:String = "controls";
      ...
      protected static const const_1044:String = "icon_message";
      
      protected static const const_1436:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1047:String = "label";
      
      protected static const const_609:String = "notification";
      
      private static const const_70:uint = 10338138;
      
      private static const const_1076:uint = 13891476;
      
      private static const const_1119:String = null;
      
      private static const const_709:String = "icon_tag_notify";
      
      private static const const_1659:String = "icon_tag_message";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1045));
         _loc3_ = _loc2_.getListItemByName(const_1435) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         _loc3_ = _loc2_.getListItemByName(const_1434) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_609,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1045));
            _loc5_ = false;
            if(this.friend.realName != null && this.friend.realName != "")
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1658).content as XML) as IWindowContainer;
               _loc3_.name = const_1435;
               _loc6_ = _loc3_.getChildByName(const_691) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2263.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1657).content as XML) as IWindowContainer;
               _loc3_.name = const_1434;
               ...
               _loc8_ = _loc3_.getChildByName(const_1436);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_168)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1045)).getListItemByName(const_465) as IWindowContainer;
            _loc1_.findChildByName(const_691).caption = this.var_168.name;
            var_2263.crop(_loc1_.getChildByName(const_691) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_317));
            _loc2_.bitmap = var_509.getAvatarFaceBitmap(this.var_168.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_483.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1656).content as XML) as IWindowContainer;
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1113:
               case const_1044:
                  this.removeNotificationToken(FriendNotification.const_430,true);
                  if(var_361 && this.var_168)
                  {
                     var_361.startConversation(this.var_168.id);
                     this.deselect(true);
                     if(param1.window.name == const_1044)
                     {
                        var_509.setMessengerIconNotify(false);
                     }
                  }
                  break;
               case const_1436:
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1119;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1359:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2261);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_709;
               break;
            case FriendNotification.const_1299:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2261);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_709;
               break;
            case FriendNotification.const_430:
               _loc4_ = new MessengerToken(this.friend,param1,param2);
               _loc4_.iconElement.name = const_1044;
