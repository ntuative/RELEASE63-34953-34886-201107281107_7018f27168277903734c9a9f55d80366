package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static var var_1440:IHabboWindowManager;
      
      protected static var var_1439:IAssetLibrary;
      
      protected static const ICON:String = "icon";
      
      protected static const const_1117:String = "title";
      
      protected static const const_1113:String = "message";
      
      protected static const const_1428:Rectangle = new Rectangle(0,0,25,25);
      ...
      protected var var_1426:FriendNotification;
      
      protected var var_1153:DropAnimation;
      ...
      {
         return this.var_1426.typeCode;
      }
      
      public function get viewOnce() : Boolean
      {
         return this.var_1426.viewOnce;
      }
      ...
      {
         var _loc7_:* = null;
         this._window = var_1440.buildFromXML(var_1439.getAssetByName(param3).content as XML) as IWindowContainer;
         this._window.findChildByName(const_1117).caption = param1;
         this._window.findChildByName(const_1113).caption = !!param2 ? param2 : "";
         _loc7_ = var_1439.getAssetByName(param5) as BitmapDataAsset;
         if(_loc7_)
         {
            IBitmapWrapperWindow(this._window.findChildByName(ICON)).bitmap = _loc7_.content as BitmapData;
         }
         this._icon = var_1440.create("ICON_" + this.typeCode,WindowType.const_325,WindowStyle.const_106,WindowParam.const_30,Token.const_1428) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1440.create("BITMAP_" + this.typeCode,WindowType.const_395,WindowStyle.const_106,WindowParam.const_197,Token.const_1428) as IBitmapWrapperWindow;
         _loc8_.disposesBitmap = false;
         _loc7_ = var_1439.getAssetByName(param4) as BitmapDataAsset;
         if(_loc7_)
         {
         ...
         if(param6)
         {
            this.var_1153 = new DropAnimation(this._icon,600,32);
         }
      }
   }
}
