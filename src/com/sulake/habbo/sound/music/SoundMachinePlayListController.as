package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_242:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_242 = param2;
         this.var_813 = [];
         this.var_813.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_813.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_813)
         {
         ...
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_852,this.onSoundMachinePlayEvent);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_749,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_852,this.onSoundMachinePlayEvent);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_749,this.onSoundMachineStopEvent);
               this.var_94 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_473);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_242.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_473 = -1;
         this.var_688 = false;
         this.var_242.stop(HabboMusicPrioritiesEnum.const_125);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_242.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_242.playSong(param1,HabboMusicPrioritiesEnum.const_125,_loc3_,0,0,0))
         {
