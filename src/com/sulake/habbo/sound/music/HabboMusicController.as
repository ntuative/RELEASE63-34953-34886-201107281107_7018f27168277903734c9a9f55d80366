package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1711:int = HabboMusicPrioritiesEnum.const_125;
      ...
      private var var_595:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_813.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_813.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_813)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_1028,this.onJukeboxInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_290,this.onJukeboxDispose);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_840,this.onSoundMachineInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_944,this.onSoundMachineDispose);
         this.var_1365 = new Timer(1000);
         this.var_1365.start();
         this.var_1365.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         ...
         {
            this.var_352[_loc6_] = null;
            this.var_906[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2134)
            {
            ...
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_140,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_309)
            {
               ...
               {
                  _loc3_ = this.var_309.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_1028,this.onJukeboxInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_290,this.onJukeboxDispose);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_840,this.onSoundMachineInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_944,this.onSoundMachineDispose);
            }
      ...
      private function addSongStartRequest(param1:int, param2:int, param3:Number, param4:Number, param5:Number, param6:Number) : Boolean
      {
         ...
         this.var_352[param1] = _loc7_;
         this.var_906[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_352[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_906[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_352.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_352[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_309.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      {
         if(this.var_733.getValue(param1) == null)
         {
            this.var_733.add(param1,param2);
      ...
      {
         return this.var_421.length;
      }
      
      public function getSongDiskInventoryDiskId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_421.length)
         {
            return this.var_421.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_421.length)
         {
            return this.var_421.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_309.length)
         {
            ...
            if(_loc3_.id != this.var_1667 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_352[_loc2_] != null)
            {
               _loc3_ = this.var_352[_loc2_];
               _loc4_ = this.var_309.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_908));
         Logger.log("Requested song info\'s : " + this.var_908);
         this.var_908 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_309.add(_loc6_.id,_loc10_);
               ...
               while(this.var_907.indexOf(_loc6_.id) != -1)
               {
                  this.var_907.splice(this.var_907.indexOf(_loc6_.id),1);
                  if(this.var_907.length == 0)
                  {
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_2134 = this.getSongRequestCountAtPriority(param1);
         this.var_1667 = param2;
         if(this._priorityPlaying <= const_1711)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2920 != param1.id || _loc3_ > this.var_2919 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2920 = param1.id;
            this.var_2919 = _loc3_;
         }
      }
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_733.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_421.add(_loc5_,_loc6_);
            if(this.var_309.getValue(_loc6_) == null)
            {
               this.var_907.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_595 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_94,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_595 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
