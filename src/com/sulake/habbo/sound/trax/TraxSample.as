package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1863:String = "sample_44khz";
      
      public static const const_1776:String = "sample_22khz";
      
      public static const const_1819:String = "sample_11khz";
      
      public static const const_1961:String = "sample_16bit";
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_182 * this.var_86;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            {
               this.var_131[int(_loc11_ / this.var_182)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_131.length * this.var_182 * this.var_86;
      }
      
      public function get usageCount() : int
      {
         return this.var_669.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_182 * this.var_86;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
