package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound, IDisposable
   {
      ...
      private static const const_1074:uint = 88000;
      
      private static const const_694:uint = 88000;
      
      private static const const_201:Vector.<int> = new Vector.<int>(const_119,true);
      ...
      private var var_1024:Sound;
      
      private var var_465:SoundChannel;
      
      private var var_468:TraxData;
      ...
      private var var_667:Boolean = true;
      ...
      {
         this.var_1527 = uint(30);
         super();
         this._events = param4;
         this.var_1528 = param1;
         this.var_992 = 1;
         this.var_1024 = new Sound();
         this.var_465 = null;
      ...
      {
         return this.var_466 / const_120;
      }
      
      public function set fadeOutSeconds(param1:Number) : void
      {
         this.var_466 = int(param1 * const_120);
      }
      
      public function get fadeInSeconds() : Number
      {
         return this.var_823 / const_120;
      }
      
      public function set fadeInSeconds(param1:Number) : void
      {
         this.var_823 = int(param1 * const_120);
      }
      ...
      public function prepare() : Boolean
      {
         ...
         if(!this.var_1531)
         {
            ...
            {
               this.var_1529 = false;
               if(this.var_468.hasMetaData)
               {
                  this.var_1529 = this.var_468.metaCutMode;
               }
               if(this.var_1529)
               {
      ...
      private function prepareLegacySequence() : Boolean
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_468.channels.length)
         {
            _loc3_ = new Map();
            _loc4_ = this.var_468.channels[_loc2_] as TraxChannel;
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            while(_loc7_ < _loc4_.itemCount)
            {
               ...
               _loc9_ = this.var_1530.getValue(_loc8_) as TraxSample;
               _loc9_.setUsageFromSong(this.var_1528,_loc1_);
               if(_loc9_ == null)
               {
               ...
               while(_loc12_ < _loc11_)
               {
                  ...
                  _loc6_ += _loc10_;
                  _loc5_ = uint(_loc6_ * const_694);
                  _loc12_++;
               }
               if(this.var_286 < _loc5_)
               {
                  this.var_286 = _loc5_;
               }
               _loc7_++;
      ...
      private function prepareSequence() : Boolean
      {
         ...
         while(_loc2_ < this.var_468.channels.length)
         {
            ...
            while(_loc8_ < _loc4_.itemCount)
            {
               ...
               _loc10_ = this.var_1530.getValue(_loc9_) as TraxSample;
               _loc10_.setUsageFromSong(this.var_1528,_loc1_);
               if(_loc10_ == null)
               {
      ...
      public function play(param1:Number = 0.0) : Boolean
      {
         ...
         this.var_550 = 0;
         this.var_667 = false;
         this.var_1024.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this.var_1526 = param1 * const_120;
         this.var_1260 = 0;
         this.var_1904 = 0;
         this.var_465 = this.var_1024.play();
      ...
      {
         if(this.var_466 > 0 && !this.var_667)
         {
      ...
      private function stopImmediately() : void
      {
         ...
         {
            this.var_1024.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         }
      }
      ...
      private function stopWithFadeout() : void
      {
         if(this.var_668 == null)
         {
            this.var_824 = true;
            this.var_550 = 0;
            this.var_668 = new Timer(this.var_1527 + this.var_466 / (const_120 / 1000),1);
            this.var_668.start();
      ...
      private function getSampleBars(param1:uint) : int
      {
         if(this.var_1529)
         {
            return Math.round(param1 / const_1074);
         }
         return Math.ceil(param1 / const_1074);
      }
      ...
      private function mixChannelsIntoBuffer() : void
      {
         ...
         while(_loc4_ >= 0)
         {
            ...
            _loc8_ = const_119;
            if(this.var_286 - this.var_181 < _loc8_)
            {
               _loc8_ = this.var_286 - this.var_181;
            }
            _loc9_ = 0;
            while(_loc9_ < _loc8_)
            {
               ...
               if(_loc4_ == _loc2_ - 1)
               {
                  if(_loc3_ != null)
                  {
                     _loc3_.setSample(const_201,_loc9_,_loc12_);
                     _loc9_ += _loc12_;
                  }
                  else
                  {
               ...
               else
               {
                  if(_loc3_ != null)
                  {
                     _loc3_.addSample(const_201,_loc9_,_loc12_);
                  }
                  _loc9_ += _loc12_;
               }
               if(_loc9_ < _loc8_)
      ...
      {
         var _loc1_:int = this.var_286 < this.var_1526 ? int(this.var_286) : (this.var_1526 > 0 ? int(this.var_1526) : int(this.var_286));
         if(this.var_181 > _loc1_ + this.var_1527 * (const_120 / 1000) && !this.var_667)
         {
            this.var_667 = true;
         ...
         else if(this.var_181 > _loc1_ - this.var_466 && !this.var_824)
         {
            this.var_1022 = false;
            this.var_824 = true;
            this.var_550 = 0;
      ...
      {
         if(param1.position > this.var_1260)
         {
            ++this.var_1904;
            Logger.log("Audio buffer under run...");
            this.var_1260 = param1.position;
         }
         if(this.volume > 0)
         {
         ...
         if(this.var_286 - this.var_181 < _loc2_)
         {
            _loc2_ = this.var_286 - this.var_181;
            if(_loc2_ < 0)
            {
               _loc2_ = 0;
            }
         ...
         this.var_1260 += const_119;
         if(this.var_465 != null)
         {
            this.var_1527 = param1.position / const_120 * 1000 - this.var_465.position;
         }
      ...
      private function writeAudioToOutputStream(param1:ByteArray, param2:int) : void
      {
         ...
         if(param2 > 0)
         {
            ...
            else
            {
               if(this.var_1022)
               {
                  _loc5_ = 1 / this.var_823;
                  _loc6_ = this.var_1023 / Number(this.var_823);
                  this.var_1023 += const_119;
                  if(this.var_1023 > this.var_823)
                  {
                     this.var_1022 = false;
                  }
               }
               else if(this.var_824)
               {
                  _loc5_ = -1 / this.var_466;
                  _loc6_ = 1 - this.var_550 / Number(this.var_466);
                  this.var_550 += const_119;
                  if(this.var_550 > this.var_466)
                  {
                     this.var_550 = this.var_466;
                  }
               }
      ...
      private function writeMixingBufferToOutputStream(param1:ByteArray, param2:int) : void
      {
         ...
         while(_loc4_ < param2)
         {
            _loc3_ = Number(Number(const_201[_loc4_]) * 0);
      ...
      private function writeMixingBufferToOutputStreamWithFade(param1:ByteArray, param2:int, param3:Number, param4:Number) : void
      {
         ...
         while(_loc6_ < param2)
         {
            ...
            _loc5_ = Number(Number(const_201[_loc6_]) * 0 * param3);
            param3 += param4;
         ...
         else if(param3 > 1)
         {
            while(_loc6_ < param2)
            {
               _loc5_ = Number(Number(const_201[_loc6_]) * 0);
               param3 += param4;
               param1.writeFloat(_loc5_);
               param1.writeFloat(_loc5_);
               _loc6_++;
      ...
      {
         this.stopImmediately();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.var_1528));
      }
