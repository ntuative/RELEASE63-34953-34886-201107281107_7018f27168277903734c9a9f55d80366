package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class PixelsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1510:uint = 4285767869;
      
      private static const const_1511:uint = 4283664040;
      
      private static const const_478:Array = ["icon_pixel_0_png","icon_pixel_1_png","icon_pixel_2_png","icon_pixel_3_png"];
      ...
      public function PixelsIndicator(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboCatalog, param4:ICoreLocalizationManager)
      {
         ...
         this.iconAnimationSequence = const_478.concat(const_478);
         this.iconAnimationDelay = 50;
         this.amountZeroText = param4.getKey("purse.pixels.zero.amount.text","Get");
         createWindow("purse_indicator_pixels_xml",const_478[0]);
         this.setAmount(0);
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_379,this.onPixelBalance);
      }
      ...
      private function onPixelBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_2058 != 0)
         {
            if(this.var_2058 > param1.balance)
            {
