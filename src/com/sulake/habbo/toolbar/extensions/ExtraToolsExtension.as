package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1652:uint = 16777215;
      
      private static const const_1653:uint = 12247545;
      
      private static const const_1654:String = "HELP";
      ...
      {
         this.var_62.removeListItem(this.var_386);
      }
      
      public function showRoomInfo() : void
      {
         this.var_62.addListItemAt(this.var_386,0);
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1654);
               break;
