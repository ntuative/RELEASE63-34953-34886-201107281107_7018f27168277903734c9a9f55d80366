package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1491:Point = new Point(3,3);
      
      private static const const_1557:uint = 7433577;
      
      private static const const_1562:uint = 5723213;
      
      private static const const_475:String = "_hover";
      
      private static const const_477:String = "_normal";
      
      private static const const_476:int = 5;
      
      private static const const_1556:int = 600;
      
      private static const const_1560:int = 80;
      ...
      private static const const_1555:int = 10;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1491;
         this._window.addEventListener(WindowEvent.const_548,this.onParentResized);
         ...
         this.var_221 = param2.buildFromXML(_loc12_.content as XML,2) as IWindowContainer;
         ...
         _loc13_.addChild(this.var_221);
         var _loc14_:ITextWindow = this.var_221.findChildByName("new_textfield") as ITextWindow;
         ...
         this.var_221.x = _loc13_.width - this.var_221.width - const_476;
         this.var_221.y = const_476;
         this.var_2638 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1556;
         if(!param1 && _loc2_ == this.var_1559)
         {
            return;
         }
         this.var_1559 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1561) : int(const_1560);
         ...
         this._window.height = _loc6_.rectangle.bottom + const_1555;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_221 != null && this.var_2638)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_756:
               _loc3_ = false;
               break;
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_475);
               this.setIconBgHoverState(_loc3_,const_475);
               break;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_475 ? this.var_1561 : this.var_1560;
         }
         else
         {
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1559 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1559 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1560)
         {
            this.var_1560.dispose();
         }
         this.var_1560 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1561)
         {
            this.var_1561.dispose();
         }
         this.var_1561 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1048.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_476;
            _loc2_.y = const_476;
            this.var_1048.add(param1,_loc2_);
         }
         return _loc2_;
      }
