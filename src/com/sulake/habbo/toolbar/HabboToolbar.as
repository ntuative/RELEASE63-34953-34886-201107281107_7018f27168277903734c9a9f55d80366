package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1719:String = "purse";
      
      private static const const_1718:String = "extra_tools";
      ...
      private var var_1390:PurseExtension;
      
      private var var_1685:ClubDiscountPromoExtension;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            ...
            if(this.var_740)
            {
               this.var_1390 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               ...
               {
                  this.var_1685 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_740.attachExtension(const_1719,this.var_1390.window,ExtensionFixedSlotsEnum.const_1971);
               this.var_740.attachExtension(const_1718,this.var_741.window,ExtensionFixedSlotsEnum.const_1978);
            }
         }
         if(this._view == null)
         {
