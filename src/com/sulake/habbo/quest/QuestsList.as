package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1539:int = 10;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_828 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_828.toggle();
         this.var_1925 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1538.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1538[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_612 = IScrollbarWindow(this._window.findChildByName("scroller"));
         this._window.center();
         this.var_62.spacing = const_1539;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1538;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1541;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1925 && !this.var_1926)
            {
               this.var_1925 = false;
