package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1527:int = 800;
      
      private static const const_1526:int = 15;
      
      private static const const_1529:int = 300;
      ...
      private var var_1264:QuestController;
      
      private var var_1025:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1264 = new QuestController(this);
         this.var_1025 = new AchievementController(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_430.events.removeEventListener(BadgeImageReadyEvent.const_219,this.var_1025.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_430.events.addEventListener(BadgeImageReadyEvent.const_219,this.var_1025.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1264.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1025.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1264.questTracker.isVisible();
      }
      ...
      {
         this.var_1264.update(param1);
         this.var_1025.update(param1);
      }
