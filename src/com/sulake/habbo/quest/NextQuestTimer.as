package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_766:int = 1000;
      
      private static const const_696:String = "next_quest";
      ...
      private function refresh() : void
      {
         ...
         if(_loc1_ < 1)
         {
            ...
            this.var_51.questController.onQuest(this.var_133);
         }
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_51.questController.questDetails.showDetails(this.var_133);
         }
      }
