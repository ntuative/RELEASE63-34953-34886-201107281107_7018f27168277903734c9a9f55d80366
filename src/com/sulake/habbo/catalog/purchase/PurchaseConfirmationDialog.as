package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2382:int = 10;
      ...
      private const const_2093:uint = 4.293848814E9;
      
      private const const_2092:uint = 4.294967295E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1231 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            _loc6_.addEventListener(WindowEvent.const_118,this.onNameInputChange);
            _loc6_.addEventListener(WindowMouseEvent.const_45,this.onNameInputMouseDown);
            _loc6_.addEventListener(WindowKeyboardEvent.const_327,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_376,this.onMessageInputFocus);
         }
         this.var_1859 = true;
         this.var_1860 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_448,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1861 = _loc1_.stuffTypes;
            this.var_808 = _loc1_.boxTypes;
            this.var_807 = _loc1_.ribbonTypes;
            this.var_1232 = this.var_1861[0];
            this.var_381 = this.var_808[0];
            this.var_382 = this.var_807[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_382 < 0)
         {
            this.var_382 = this.var_807.length - 1;
         }
         if(this.var_382 > this.var_807.length - 1)
         {
            this.var_382 = 0;
         }
         if(this.var_381 < 0)
         {
            this.var_381 = this.var_808.length - 1;
         }
         if(this.var_381 > this.var_808.length - 1)
         {
            this.var_381 = 0;
         }
         var _loc1_:int = this.var_808[this.var_381] * 1000 + this.var_807[this.var_382];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1232,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1499 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1861)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1232);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_808[this.var_381]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_807[this.var_382]);
         this._catalog.purchaseProductAsGift(this.var_1500,this.var_1231,this.var_1501,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1500,this.var_1231,this.var_1501);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_251)
         {
            ...
            if(_loc4_.length >= this.const_2382)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2473 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_383 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_383 + 1);
               break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_383) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_809 == null)
         {
            this.var_809 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_282 == null || this.var_809 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_809.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_383) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_383);
         }
         this.var_383 = param1;
         if(this.var_383 < 0)
         {
            this.var_383 = _loc2_.numListItems - 1;
         }
         if(this.var_383 >= _loc2_.numListItems)
         {
            this.var_383 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_383) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1653;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2093) : uint(this.const_2092);
      }
      ...
      {
         this.var_1232 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1232;
               }
            }
            _loc4_++;
         }
