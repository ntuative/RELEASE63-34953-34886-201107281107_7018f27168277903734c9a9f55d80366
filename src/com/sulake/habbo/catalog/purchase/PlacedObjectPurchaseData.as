package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_1938:IProductData;
      
      private var var_656:IFurnitureData;
      ...
      {
         this.var_1231 = param1.offerId;
         this.var_1939 = param1.productContainer.firstProduct.productClassId;
         this.var_1938 = param1.productContainer.firstProduct.productData;
         this.var_656 = param1.productContainer.firstProduct.furnitureData;
         this.var_1501 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_238,this._category,this.var_2075,this._x,this.var_177,this._direction,this.var_1231,this.var_1939].toString();
      }
