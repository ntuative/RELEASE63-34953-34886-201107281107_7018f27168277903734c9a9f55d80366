package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1078:int = 0;
      ...
      {
         return this.var_672 != const_1078;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1914 != RecyclerStatusMessageEvent.const_1361;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_672 == const_473;
      }
      ...
      {
         this.var_672 = const_1077;
         this.var_132 = new Array(const_213);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1914)
         {
            case RecyclerStatusMessageEvent.const_1813:
               this.var_672 = const_473;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1361:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1771:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1175:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1841:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_132.length < const_213)
         {
            return false;
         }
         var _loc1_:int = 0;
