package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_512:IItemGridWindow;
      ...
      protected var var_216:Boolean = true;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_809,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_250,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_897,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_309,this.deActivateScrollbar);
         }
         this.var_33 = param2;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_218.stop();
            this.var_218.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_218 = null;
         }
         if(this.var_512 != null)
         {
            this.var_512.destroyGridItems();
            this.var_512 = null;
         }
         this.var_1849 = null;
         this.var_239 = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_512 = _window.findChildByName("itemGrid") as IItemGridWindow;
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1849 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_216)
         {
            this.var_218 = new Timer(25);
            this.var_218.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_218.start();
         }
         else
         {
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_811 >= 0 && this.var_811 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_811];
                  this.loadGraphics(_loc4_);
                  _loc4_.productContainer.grid = this;
               }
               ++this.var_811;
               if(this.var_811 >= _loc2_)
               {
                  this.resetTimer();
                  break;
               }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         this.var_512.addGridItem(_loc2_);
         ...
         if(param1.pricingModel == Offer.const_653)
         {
            ++this.var_1871;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1871);
         }
      }
