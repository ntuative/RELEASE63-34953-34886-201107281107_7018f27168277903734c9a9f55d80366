package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1717:int = 18;
      ...
      private var var_213:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_118,this.onTextWindowEvent);
         ...
         this.var_600 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_600 < 8)
         {
            return false;
         }
         this.var_2317 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_213 != null && this.var_213.length > 0)
         {
            this.var_425 = this.var_213[0];
         }
         else
         {
            this.var_425 = -1;
         }
         this._offers.add(this.var_600,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_213 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1717 && _loc2_ < this.var_213.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_600,this.var_213[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_213 != null && this.var_213.length > 0)
         {
            ...
            this.var_425 = this.var_213[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_600,this.var_425),this.getRaceLocalizationKey(this.var_600,this.var_425));
            }
         }
         return this.getRaceLocalizationKey(this.var_600,this.var_425);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_425 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_600;
         var _loc3_:int = this.var_425;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_425 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
