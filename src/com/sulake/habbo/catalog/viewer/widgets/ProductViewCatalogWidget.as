package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_542:IDisplayObjectWrapper;
      
      private var var_1875:Point;
      
      private var var_543:IItemGridWindow;
      
      private var var_1506:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1001 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1240 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_198 != null)
         {
            ...
            this.var_542 = this.var_198.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_542 != null && _loc3_ != null)
            {
               this.var_198.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_542.width,this.var_542.height);
               if(_loc4_ != null)
               {
                  this.var_542.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1875 = new Point(this.var_99.x,this.var_99.y);
         this.var_543 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1506 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1001.text = _loc4_;
         this.var_1240.text = _loc5_;
         this.var_1001.height = this.var_1001.textHeight + 5;
         this.var_1240.y = this.var_1001.y + this.var_1001.height;
         this.var_1240.height = Math.max(130,this.var_1240.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_653:
                  ...
                  if(this.var_543 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_543,this.var_1506,this.var_1849);
                     this.var_543.scrollV = 0;
                  }
                  if(this.var_198 != null)
                  {
                     this.var_198.visible = false;
               ...
               case Offer.const_452:
                  ...
                  if(this.var_198 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_72 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_191)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_72:
                        if(_loc8_ != null && this.var_542 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_359,AvatarAction.const_678);
                                 _loc18_.appendAction(AvatarAction.const_328,_loc9_.productClassId);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_99 != null && true)
         {
            ...
            this.var_99.x = this.var_1875.x;
            this.var_99.y = this.var_1875.y;
            if(param3 != null)
            {
