package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1050.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1050 = null;
         }
         if(this.var_1049 != null)
         {
            this.var_1049.removeEventListener(WindowKeyboardEvent.const_196,this.windowKeyEventProcessor);
            this.var_1049 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1050 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1050 != null)
         {
            this.var_1050.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1049 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1049 != null)
         {
            this.var_1049.addEventListener(WindowKeyboardEvent.const_196,this.windowKeyEventProcessor);
         }
         return true;
      }
