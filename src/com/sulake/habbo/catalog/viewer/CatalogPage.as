package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2077:String = "ctlg_";
       
      
      protected var var_2278:XML;
      ...
      {
         var _loc2_:String = const_2077 + param1;
         ...
         this.var_2278 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2278) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            ...
            case CatalogWidgetEnum.const_2027:
               ...
               break;
            case CatalogWidgetEnum.const_1810:
            ...
            case CatalogWidgetEnum.const_1875:
               ...
               break;
            case CatalogWidgetEnum.const_2031:
            ...
            case CatalogWidgetEnum.const_1858:
               ...
               break;
            case CatalogWidgetEnum.const_1851:
