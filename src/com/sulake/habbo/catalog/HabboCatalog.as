package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private var var_1250:IRoomSession;
      ...
      private var var_266:ICatalogNavigator;
      ...
      private var var_212:PurchaseConfirmationDialog;
      ...
      private var var_3045:Boolean = true;
      
      private var var_3046:Boolean = true;
      
      private var var_2213:Boolean = false;
      
      private var var_3047:GiftWrappingConfiguration;
      
      private var var_1409:ClubGiftController;
      
      private var var_605:ClubBuyController;
      
      private var var_927:ClubExtendController;
      
      private var var_926:Map;
      
      private var var_1408:Boolean = false;
      
      private var var_928:IPurchasableOffer;
      
      private var var_1706:IDragAndDropDoneReceiver;
      
      private var var_67:PlacedObjectPurchaseData;
      
      private var var_1705:Boolean;
      
      private var var_3044:Boolean;
      
      private var var_753:RoomPreviewer;
      
      private const const_2097:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_83,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1868);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_430.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_212 == null || this.var_212.disposed)
            {
               this.var_212 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_212.showOffer(this,this._roomEngine,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_605.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_3044 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_430.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_167,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_164 != null && this.var_164.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_753 == null)
            {
               this.var_753 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_164.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_917 || !this.var_266 || !this.var_266.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1139 = -1;
            this.var_929 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_266.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_164.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_430.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_430.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_63)
         {
            _loc3_ = this.var_430.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_926.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_266 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         if(this.var_164.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_731) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2097;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_78:
               this.var_2213 = param1.session.isPrivateRoom;
               this.var_1250 = param1.session;
               if(this.var_107 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1409 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_605 == null)
         {
            this.var_605 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_927 == null)
         {
            this.var_927 = new ClubExtendController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1705 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_266.buildCatalogIndex(_loc2_);
         if(this.var_929 && this.var_929 != "")
         {
            this.var_266.openPage(this.var_929);
            this.var_929 = "";
            this.var_1139 = -1;
         }
         else if(this.var_1139 > -1)
         {
            this.var_266.openPageById(this.var_1139,this.var_2214);
            this.var_1139 = -1;
            this.var_2214 = -1;
            this.var_929 = "";
         }
         else if(this.var_1705 && this.var_3044)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_266.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1878));
         }
         else
         {
            this.var_266.loadFrontPage();
         }
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_3045 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1213);
         }
         this.var_3045 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_138,this.var_118.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_3046 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1302);
         }
         this.var_3046 = false;
         if(this.var_235 != null && !this.var_235.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_379,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_853)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_368,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_379,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_368,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_118.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1290 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1409.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_3047 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_212 != null)
         {
            this.var_212.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_926.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_926.add(_loc2_.productCode,_loc3_.slice());
      ...
      {
         if(!this.var_164.keyExists("catalog.drag_and_drop") || this.var_164.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1250 || !this.var_1250.isRoomOwner)
         {
            return false;
         }
         ...
         {
            case ProductTypeEnum.const_191:
               _loc3_ = false;
               break;
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_228);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1408 && param1.type == RoomEngineObjectEvent.const_167)
         {
            this.method_1(true);
            if(this.var_928 == null || this.var_928.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_928.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_67 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_928);
      ...
      public function method_1(param1:Boolean = false) : void
      {
         if(!param1)
         {
            this.resetObjectMover();
            ...
            if(this.var_67.roomCategory == this._roomEngine.activeRoomCategory && this.var_67.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  ...
                  case FurniCategory.const_369:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_228);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_164.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_731);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_753 != null)
         {
            this.var_753.updatePreviewRoomView();
         }
      }
   }
}
