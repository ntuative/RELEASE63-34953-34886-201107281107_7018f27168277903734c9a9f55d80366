package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_2138:int = 1;
      
      public const const_2221:int = 2;
      ...
      private var var_212:MarketplaceConfirmationDialog;
      ...
      private var var_2450:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_279);
            this.var_279 = null;
         }
         if(this.var_326 != null)
         {
            this.disposeOffers(this.var_326);
            this.var_326 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_212)
         {
            this.var_212 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_212.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2454,this.var_2451,this.var_2456,this.var_2449);
      }
      ...
      {
         if(!this.var_279 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_279.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_2138,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_326.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_326.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_518)
            {
               this.var_326.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_279.add(_loc4_.offerId,_loc5_);
         }
         this.var_2457 = _loc3_.totalItemsFound;
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2452 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_326.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_279.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_279.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_279.add(parser.offerId,updateItem);
            }
            this.var_279.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_2221,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_326.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2453 || param1.furniTypeId != this.var_2455)
         {
            return;
         }
