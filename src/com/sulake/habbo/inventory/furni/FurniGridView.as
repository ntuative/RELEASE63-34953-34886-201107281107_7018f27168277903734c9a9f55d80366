package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_232 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_232.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_232.autoArrangeItems = false;
            this.var_232.lock();
         }
         else
         {
            this.var_232.autoArrangeItems = true;
            this.var_232.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_78.toggleItemSelection(this._category,this.var_232.getGridItemIndex(param1.window));
            this.var_598 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_598 != null && this.var_598 == param2 && !this.var_78.isTradingOpen)
         {
