package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_455 = [];
         this.var_454 = [];
         this.var_657 = new Timer(const_1508,1);
         this.var_657.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2459 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_167,this.onObjectPlaced);
               }
            ...
            {
               this.var_657.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_657.stop();
               this.var_657 = null;
            }
            if(this.var_216 != null)
            {
               this.var_216.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_216.stop();
               this.var_216 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         this.var_27.setInventoryCategoryInit(InventoryCategory.const_71);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_333)
         {
         ...
         else if(param3 == FurniCategory.const_369)
         {
         ...
         if(this.var_804 == null)
         {
            this.var_804 = this._windowManager.buildFromXML(this.var_2459) as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_37,const_44];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_216 = new Timer(param1,1);
            this.var_216.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_216.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_71 && this.var_27.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_281:
                  this.var_27.toggleInventoryPage(InventoryCategory.const_134);
            }
         }
      }
      ...
      {
         this.var_2460 = getTimer();
         this.switchCategory(const_281);
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_407);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_37,const_44];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_37,const_44];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_656.add(const_37,new Array());
         this.var_656.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_37;
            _loc5_ = this.var_455.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_44;
            _loc5_ = this.var_454.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_281)
            {
      ...
      {
         return getTimer() < this.var_2460 + const_1507;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_333 || _loc3_.category == FurniCategory.const_326 || _loc3_.category == FurniCategory.const_369)
         {
            if(param1)
            {
               return false;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_383:
               ...
               break;
            case InventorySubCategory.const_52:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_656.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_811)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_455.indexOf(_loc2_) == -1)
            {
               this.var_455.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_454.indexOf(_loc2_) == -1)
            {
               this.var_454.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_459:
               return this.var_455.length;
            case UnseenItemCategoryEnum.const_425:
               return this.var_454.length;
            default:
               return this.var_455.length + this.var_454.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_44:
               if(this.var_454 && this.var_454.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_425));
                  this.var_454 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_37:
               if(this.var_455 && this.var_455.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_459));
                  this.var_455 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
