package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1513:int = 13421772;
      
      private static const const_1512:int = 10275685;
      ...
      protected var var_946:int = 0;
      
      protected var var_760:BitmapData;
      
      protected var var_2484:int;
      
      protected var var_1727:Boolean;
      
      protected var var_2280:Boolean;
      
      protected var var_3077:BitmapData;
      
      private var var_1629:Boolean;
      
      private const const_2122:Number = 1;
      
      private const const_2121:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2502 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2281 == FurniModelCategory.const_37)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_2192));
         }
         else
         {
      ...
      public function getOneForTrade() : IItem
      {
         ...
         while(_loc1_ < this._items.length)
         {
            ...
            if(!_loc2_.locked && _loc2_.method_4)
            {
               return _loc2_;
            }
            _loc1_++;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_811)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function getTradeableCount() : int
      {
         ...
         {
            _loc3_ = this._items.getWithIndex(_loc2_) as IItem;
            if(_loc3_.method_4 && !_loc3_.locked)
            {
               _loc1_++;
            }
            _loc2_++;
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2121;
               _loc1_.blend = this.const_2121;
            }
            else
            {
               this._window.blend = this.const_2122;
               _loc1_.blend = this.const_2122;
            }
         }
         this.var_1618.color = !!this.var_1629 ? uint(const_1512) : uint(const_1513);
         this.var_2502.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2280 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3077;
               _loc5_.visible = true;
            }
            else
            {
