package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_256 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_256.id);
            this.var_256 = null;
         }
      }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_256 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_256.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_256 is FloorItem ? 1 : 2;
         this.var_2453 = _loc2_;
         this.var_2455 = this.var_256.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_256.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_256);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_2196,this.var_2197);
         }
      }
      ...
      {
         if(param1 != this.var_2453 || param2 != this.var_2455)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2458);
      }
