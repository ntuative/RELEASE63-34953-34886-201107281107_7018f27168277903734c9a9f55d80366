package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2389:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_430 = param5;
         this.var_430.events.addEventListener(BadgeImageReadyEvent.const_219,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_430.events.removeEventListener(BadgeImageReadyEvent.const_219,this.onBadgeImageReady);
            this.var_430 = null;
         }
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_862[_loc2_] == param1)
            {
               this.var_862.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1313.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_711.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_430.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_258.unshift(_loc11_);
            }
            else
            {
               this.var_258.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_375);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_258.length)
         {
            _loc3_ = this.var_258[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_608);
         ...
         var _loc3_:Array = this.getBadges(const_375);
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case const_608:
               _loc2_ = new Array();
               for each(_loc3_ in this.var_258)
               {
                  if(!_loc3_.isInUse)
                  {
                     _loc2_.push(_loc3_);
      ...
      {
         return this.getItemInIndex(param1,const_375);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_608);
      }
      ...
      {
         if(param1 == InventoryCategory.const_226 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_711.indexOf(_loc2_) == -1)
            {
               this.var_711.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_711 && this.var_711.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1423));
            this.var_711 = [];
