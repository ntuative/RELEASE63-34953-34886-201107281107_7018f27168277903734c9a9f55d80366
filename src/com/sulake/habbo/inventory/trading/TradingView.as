package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1073:uint = 4284532064;
      
      private static const const_1072:uint = 2577770;
      ...
      private var var_666:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_666 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_218)
            {
               this.var_218.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_218.stop();
               this.var_218 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1894 = this.createMinimizedWindow();
         }
         if(!this.var_1163)
         {
            return this.var_80;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_80)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1073) : uint(const_1072);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1073) : uint(const_1072);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_218 = new Timer(1000,3);
            this.var_218.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_218.reset();
         this.var_218.repeatCount = 3;
         this.var_218.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_218.currentCount));
         if(this.var_218.currentCount == 3)
         {
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1922)
            {
            ...
            this.var_666.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_650);
            this.var_666.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_666.hideDelayed();
         }
      }
         ...
         if(this.var_200.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_666.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_650);
               }
            }
            else
            {
