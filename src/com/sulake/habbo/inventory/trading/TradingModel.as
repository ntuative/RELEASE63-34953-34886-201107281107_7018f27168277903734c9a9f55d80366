package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_2066:uint = 9;
      ...
      public static const const_338:uint = 3;
      
      public static const const_542:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_61.updateItemList(this.var_821);
         this.var_61.updateItemList(this.var_1525);
      ...
      public function close() : void
      {
         if(this.var_864)
         {
            if(this._state != const_206 && this._state != const_296)
            {
      ...
      {
         this.var_61.setMinimized(param1 != InventoryCategory.const_71);
         this.var_12.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_822 + " OTHER: " + this.var_1257);
         ...
         {
            case const_206:
               if(param1 == const_207 || param1 == const_296)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         {
            _loc2_ = this.var_285.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_61.alertPopup(TradingView.const_1239);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_821)
            {
               this.var_822 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1257 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_61.updateUserInterface();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_285.length < const_2066)
         {
         ...
         else
         {
            ...
            if(this.var_285.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
