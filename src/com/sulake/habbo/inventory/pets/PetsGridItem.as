package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1628.setSelectedGridItem(this);
               this.var_1627 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1627 = false;
                  this.var_1628.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1618)
         {
            return;
         }
         this.var_1618.color = !!this.var_1505 ? uint(const_1512) : uint(const_1513);
         this.var_2502.visible = param1;
      }
