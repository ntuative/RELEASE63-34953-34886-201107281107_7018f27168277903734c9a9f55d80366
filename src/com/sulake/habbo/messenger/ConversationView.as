package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         ...
         this.var_2658 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_160.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1094 + const_1566)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_160.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1565;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_564 == null || _loc1_.id != this.var_564.id)
         {
            this.var_564 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_564.followingAllowed)
         {
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_564.messages.length - const_1094);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_564.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_564.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_160.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_894 || param3.type == Message.const_890 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_564.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_160.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_160.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_160.send(new FollowFriendMessageComposer(this.var_564.id));
         this.var_160.send(new EventLogMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_160.conversations.closeConversation();
