package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_207:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_164 && this._localization && this._friendList && this.var_613 && this._soundManager)
         {
            unlock();
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_207 = new MessengerView(this);
      ...
      public function startConversation(param1:int) : void
      {
         ...
         else
         {
            ...
            this.var_207.openMessenger();
            this.var_207.refresh();
         }
      }
      
      public function method_8() : IConversation
      {
      ...
      {
         return this.var_207 && this.var_207.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_207)
         {
            if(this.var_207.isMessengerOpen())
            {
               this.var_207.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_890,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function addMsg(param1:Message) : void
      {
         ...
         if(!this.var_207.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1364);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1296,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
