package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1982:int = 1;
      
      public static const const_1974:int = 2;
      
      public static const const_1216:int = 3;
      
      public static const const_1014:int = 4;
      
      public static const const_1422:int = 5;
      
      public static const const_1838:int = 6;
      
      public static const const_2037:int = 7;
      
      public static const TYPE_ISSUEHANDLER:int = 8;
      
      public static const const_1890:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_2019[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2019[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
