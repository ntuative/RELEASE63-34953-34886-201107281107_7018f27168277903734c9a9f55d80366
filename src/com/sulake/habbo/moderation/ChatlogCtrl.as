package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1035:Array = [];
      
      private static var var_1932:int = 1000;
      
      private static var var_1034:Array = [];
      
      private static var var_1933:int = 200;
      ...
      private var var_1931:IMessageComposer;
      ...
      {
         this.var_829 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_830 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         this.var_522 = new Timer(1000,1);
         ...
         this.var_36.connection.send(this.var_1931);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1035.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1934[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1544.getValue(param2.chatterName))
            {
               this.var_1544.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1544.getValue(_loc2_);
