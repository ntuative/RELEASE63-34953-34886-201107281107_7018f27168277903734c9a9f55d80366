package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1059:OffenceCategoryData;
      
      private var var_1060:OffenceData;
      
      private var var_1303:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1303 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1301 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1948;
         ...
         this.var_1302 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1302);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1059 != null;
         if(this.var_1060 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1060.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1059 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1059.offences,this.var_1303,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1301,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_2037;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1591,this.var_575.text,this.var_1590));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1059 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1060 = this.var_1059.offences[_loc3_];
         this.var_575.text = this.var_1060.msg;
         this.var_639 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1591,this.var_575.text,this.var_1590));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1302.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1591,this.var_575.text,this.getBanLength(),this.var_1590));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1302.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1303.destroy();
            this.var_1303 = null;
         }
         if(this.var_1301 != null)
         {
            this.var_1301.destroy();
            this.var_1301 = null;
         }
         this.var_1302 = null;
         this.var_575 = null;
