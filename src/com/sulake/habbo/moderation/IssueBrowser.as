package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2395:String = "my_issues";
      
      private const const_2396:String = "open_issues";
      
      private const const_2397:String = "picked_issues";
      
      private const const_2407:String = "closed_issues";
      ...
      private var var_2060:IIssueBrowserView;
      
      private var var_2059:IIssueBrowserView;
      
      private var var_2061:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_301 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_301.numTabItems)
            {
               _loc5_ = this.var_301.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_301 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_301 == null || this.var_301.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_301.selector.getSelectableByName("open_issues");
         this.var_301.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_410.view.width = this.var_301.container.width;
         this.var_410.view.height = this.var_301.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2395:
               ...
               {
                  this.var_2060 = new MyIssuesView(this.issueManager,this,this.var_301.container);
               }
               return this.var_2060;
            case this.const_2396:
               if(this.var_2059 == null)
               {
                  this.var_2059 = new OpenIssuesView(this.issueManager,this,this.var_301.container);
               }
               return this.var_2059;
            case this.const_2397:
               if(this.var_2061 == null)
               {
                  this.var_2061 = new PickedIssuesView(this.issueManager,this,this.var_301.container);
               }
