package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_548:UserInfoCtrl;
      
      private var var_1251:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_42,this.onResized);
         }
         ...
         this.var_548 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         this.var_1251 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
         this.var_548.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1251.load(_loc4_,this.var_180.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_74 != null && this.var_74.issueManager != null && this.var_180 != null)
         {
            this.var_74.issueManager.removeHandler(this.var_180.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_180.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_180.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.closeBundle(this.var_180.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.issueManager.releaseBundle(this.var_180.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_74.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_74,WindowTracker.const_1216,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_548 = new UserInfoCtrl(this._window,this.var_74,_loc3_.message);
            this.var_548.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
