package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_833:IssueMessageData = null;
      
      private var var_832:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2622 = param2.pickerUserId;
         this.var_2623 = param2.pickerUserName;
         this.var_1664 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1276 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1275;
         }
         if(this.var_833 == null || param1.timeStamp < this.var_833.timeStamp)
         {
            this.var_833 = param1;
         }
         if(this.var_832 == null || param1.priority > this.var_832.timeStamp)
         {
            this.var_832 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1276 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1275;
            }
            if(this.var_833 == _loc2_)
            {
               this.var_833 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_832;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_833;
         if(_loc2_ == null)
         {
