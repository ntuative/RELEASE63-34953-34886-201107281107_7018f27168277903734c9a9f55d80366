package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1283:IDropMenuWindow;
      
      private var var_575:ITextFieldWindow;
      
      private var var_639:Boolean = true;
      
      private var var_1108:ICheckBoxWindow;
      
      private var var_1652:ICheckBoxWindow;
      
      private var var_1653:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_379));
         Logger.log("BEGINNING TO SHOW: " + this.var_379);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_379);
         if(param1.flatId != this.var_379)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_379);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_575 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_575.procedure = this.onInputClick;
         this.var_1283 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1283);
         this.var_1283.procedure = this.onSelectTemplate;
         this.var_1108 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1652 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1653 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_1014,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_639 || this.var_575.text == "")
         {
            this.var_36.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1108.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1782,_loc2_,this.var_575.text,"",""));
         if(this.var_1652.isSelected || this.var_1653.isSelected || this.var_1108.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1652.isSelected,this.var_1653.isSelected,this.var_1108.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1780);
      }
      
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type != WindowEvent.const_376)
         {
            return;
         }
         if(!this.var_639)
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1283.selection];
         if(_loc3_ != null)
         {
            this.var_639 = false;
            this.var_575.text = _loc3_;
         }
      }
   }
}
