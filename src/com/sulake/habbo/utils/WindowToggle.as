package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1846:int = 1;
      ...
      private var var_1689:Function;
      
      private var var_1128:Function;
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_1129)
            {
               this.var_1129.addChild(this._window);
            }
