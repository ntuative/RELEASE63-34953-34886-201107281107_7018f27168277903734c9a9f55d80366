package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1792 = int(this.var_164.getKey("latencytest.interval"));
         this.var_1791 = int(this.var_164.getKey("latencytest.report.index"));
         this.var_2381 = int(this.var_164.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1790 > this.var_1792)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1790 = getTimer();
         this.var_635.add(this.var_1463,this.var_1790);
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_635 == null || this.var_244 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_635.getValue(_loc2_.requestId);
         this.var_635.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_244.push(_loc4_);
         if(this.var_244.length == this.var_1791 && this.var_1791 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1793) > this.var_2381 || this.var_1793 == 0)
            {
               this.var_1793 = _loc9_;
