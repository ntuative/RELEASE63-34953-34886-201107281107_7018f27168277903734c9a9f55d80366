package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1054:uint = 11;
      ...
      private var var_443:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_443 = new ToolbarClickTracker(this);
         this.var_1458 = new Array(const_1054);
         var _loc4_:int = 0;
         while(_loc4_ < const_1054)
         {
            this.var_1458[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1839,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1862,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2058,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_757,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1223,String(0));
         }
         ...
         if(!disposed)
         {
            ...
            if(this.var_215)
            {
               if(!this.var_215.disposed)
               {
                  ...
                  Component(this.var_215).events.removeEventListener(HabboFriendListTrackingEvent.const_538,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_220,this.onRoomAdClick);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_164)
         {
            if(this.var_273 != null)
            {
               this.var_273.configuration = this.var_164;
            }
            if(this.var_274 != null)
            {
               this.var_274.configuration = this.var_164;
            }
            ...
            if(this.var_164)
            {
               ...
               {
                  this.var_633.configure(this.var_164);
               }
               if(this.var_444 != null)
               {
                  this.var_444.configure(this.var_164);
               }
               if(this.var_443 != null)
               {
                  this.var_443.configure(this.var_164);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_638,this.onHotelViewEvent);
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1799);
         }
         else if(param1.type == HabboHotelViewEvent.const_638)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_2052);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_743:
               this.trackLoginStep(HabboLoginTrackingStep.const_1826,String(this._communication.port));
               break;
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_164)
            {
               if(this.var_164.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1458)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1201);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1201,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_215).events.addEventListener(HabboFriendListTrackingEvent.const_538,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_538:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1223,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_757,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_220,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_343.events.addEventListener(AdEvent.const_579,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_443)
         {
            this.var_443.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_443)
         {
            this.var_443.track(param1.type);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_527 > -1 && _loc2_ < this.var_527)
         {
            ++this.var_1781;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1781);
         }
         if(this.var_527 > -1 && _loc2_ - this.var_527 > 15000)
         {
            ++this.var_1779;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1779);
         }
         this.var_527 = _loc2_;
         if(this.var_274 != null)
         {
            this.var_274.update(param1,this.var_527);
         }
         if(this.var_273 != null)
         {
            this.var_273.update(param1,this.var_527);
         }
         if(this.var_444 != null)
         {
            this.var_444.trackUpdate(param1,this,this.var_527);
         }
         if(this.var_633 != null)
         {
            this.var_633.update(this.var_527);
         }
      }
   }
}
