package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_209:String = "regular";
      ...
      private static var var_579:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_706:String = "{";
      
      private static const const_707:String = "}";
      
      private static const const_1651:String = "/*";
      
      private static const const_1650:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_100[const_209],var_100[ITALIC],var_100[BOLD]];
            var_100.reset();
            var_100[const_209] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_579.indexOf(_loc4_.name) == -1)
            {
               var_579.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_707);
         if(countSubStrings(param1,const_706) != countSubStrings(param1,const_707))
         {
            throw new Error("Mismatching amount of \"" + const_706 + "\" versus \"" + const_707 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1651) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1650) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_706)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
