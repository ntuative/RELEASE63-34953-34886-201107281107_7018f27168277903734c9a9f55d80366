package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1303:String = "_EXCLUDE";
      
      public static const const_2231:String = "_INCLUDE";
      
      public static const const_2321:String = "_TEMP";
      
      private static const const_1754:String = "layout";
      
      private static const name_6:String = "window";
      
      private static const const_1174:String = "variables";
      
      private static const const_1173:String = "filters";
      
      private static const const_691:String = "name";
      
      private static const const_1748:String = "style";
      
      private static const const_736:String = "params";
      
      private static const const_1753:String = "tags";
      ...
      private static const const_1745:String = "visible";
      
      private static const const_1749:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1413:String = "blend";
      
      private static const const_1755:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1752:String = "treshold";
      
      private static const const_1746:String = "children";
      
      private static const const_1744:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1742:String = "height_min";
      
      private static const const_1743:String = "height_max";
      
      private static const const_737:String = "true";
      
      private static const const_185:String = "0";
      
      private static const const_1747:String = "$";
      
      private static const const_1720:String = ",";
      
      private static const const_52:String = "";
      
      private static const const_1750:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1751:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1438:Dictionary;
      
      protected var var_1437:Dictionary;
      
      protected var var_1162:Dictionary;
      
      protected var var_1728:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1437 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1438,this.var_1437);
         this.var_1162 = new Dictionary();
         this.var_1728 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1162,this.var_1728);
         this.var_2291 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1751,const_52);
         return param1.replace(const_1750,const_52);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1438)
            {
               delete this.var_1438[_loc1_];
            }
            for(_loc1_ in this.var_1437)
            {
               delete this.var_1437[_loc1_];
            }
            for(_loc1_ in this.var_1162)
            {
               delete this.var_1162[_loc1_];
            }
            for(_loc1_ in this.var_1728)
            {
               delete this.var_1728[_loc1_];
            }
            this.var_2291.dispose();
            this.var_2291 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1754)
         {
            _loc8_ = param1.child(const_1174);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1173).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var params:uint = 0;
         var tag:String = const_52;
         var id:int = 0;
         type = this.var_1438[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_691,variables,"")));
         style = uint(this.parseAttribute(xml,const_1748,variables,style));
         params = uint(this.parseAttribute(xml,const_736,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1753,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1745,variables,visible.toString()) == const_737;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_736).length() > 0)
         {
            list = xml.child(const_736).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_691,variables,"") as String;
               if(this.var_1162[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_691)) + "\"!");
               }
               params |= this.var_1162[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_52) : const_52;
         caption = unescape(String(this.parseAttribute(xml,const_1749,variables,caption)));
         if(tag != const_52)
         {
            tags = tag.split(const_1720);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1174)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1744,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1742,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1743,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_737;
         blend = Number(this.parseAttribute(xml,const_1413,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1755,variables,window.clipping.toString()) == const_737;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1752,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1173).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_235)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_52;
         var _loc3_:String = this.var_1437[param1.type];
         ...
         _loc2_ += "<" + _loc3_ + " x=\"" + param1.x + "\"" + " y=\"" + param1.y + "\"" + " width=\"" + param1.width + "\"" + " height=\"" + param1.height + "\"" + " params=\"" + param1.param + "\"" + " style=\"" + param1.style + "\"" + (param1.name != const_52 ? " name=\"" + escape(param1.name) + "\"" : const_52) + (param1.caption != const_52 ? " caption=\"" + escape(param1.caption) + "\"" : const_52) + (param1.id != 0 ? " id=\"" + param1.id.toString() + "\"" : const_52) + (param1.color != 16777215 ? " color=\"0x" + param1.alpha.toString(16) + param1.color.toString(16) + "\"" : const_52) + (param1.blend != 1 ? " blend=\"" + param1.blend.toString() + "\"" : const_52) + (param1.visible != true ? " visible=\"" + param1.visible.toString() + "\"" : const_52) + (param1.clipping != true ? " clipping=\"" + param1.clipping.toString() + "\"" : const_52) + (param1.background != false ? " background=\"" + param1.background.toString() + "\"" : const_52) + (param1.mouseThreshold != 10 ? " treshold=\"" + param1.mouseThreshold.toString() + "\"" : const_52) + (param1.tags.length > 0 ? " tags=\"" + escape(param1.tags.toString()) + "\"" : const_52) + (_loc6_.minWidth > int.MIN_VALUE ? " width_min=\"" + _loc6_.minWidth + "\"" : const_52) + (_loc6_.maxWidth < int.MAX_VALUE ? " width_max=\"" + _loc6_.maxWidth + "\"" : const_52) + (_loc6_.minHeight > int.MIN_VALUE ? " height_min=\"" + _loc6_.minHeight + "\"" : const_52) + (_loc6_.maxHeight < int.MAX_VALUE ? " height_max=\"" + _loc6_.maxHeight + "\"" : const_52) + ">\r";
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1303) == -1)
                  {
