package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      private var var_206:Object;
      
      private var _type:String;
      
      private var var_2832:Boolean;
      
      private var var_3114:Boolean;
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_206 = param2;
         this._type = param3;
         this.var_2832 = param4;
         this.var_3114 = param3 == const_292 || param3 == const_150 || param3 == const_291 || param3 == const_246;
      ...
      public function toString() : String
      {
         ...
         {
            case const_146:
               return "0x" + uint(this.var_206).toString(16);
            case const_38:
               return Boolean(this.var_206) == true ? "true" : "false";
            case const_291:
               return "Point(" + Point(this.var_206).x + ", " + Point(this.var_206).y + ")";
            case const_246:
               return "Rectangle(" + Rectangle(this.var_206).x + ", " + Rectangle(this.var_206).y + ", " + Rectangle(this.var_206).width + ", " + Rectangle(this.var_206).height + ")";
            default:
      ...
      public function toXMLString() : String
      {
         ...
         {
            case const_292:
               _loc3_ = this.var_206 as Map;
               _loc1_ = "<var key=\"" + this.var_718 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_291:
               ...
               break;
            case const_246:
               _loc6_ = this.var_206 as Rectangle;
               _loc1_ = "<var key=\"" + this.var_718 + "\">\r<value>\r<" + this._type + ">\r";
               ...
               break;
            case const_146:
               _loc1_ = "<var key=\"" + this.var_718 + "\" value=\"" + "0x" + uint(this.var_206).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_718 + "\" value=\"" + this.var_206 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
