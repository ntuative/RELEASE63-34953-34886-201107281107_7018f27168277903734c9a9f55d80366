package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2133:String = "_POINTER_UP";
      
      private static const const_2135:String = "_POINTER_DOWN";
      
      private static const const_2134:String = "_POINTER_LEFT";
      
      private static const const_2136:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_1010,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
         ...
         if(this.var_919 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_957,this.var_919,PropertyStruct.const_40,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_1010:
