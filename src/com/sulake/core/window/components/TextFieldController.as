package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1714:uint = 500;
      
      protected var var_1423:String = "";
      
      protected var var_1432:Boolean = false;
      
      protected var var_917:Boolean = false;
      ...
      {
         this.var_1423 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_917 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc2_ && !param1)
         {
            _loc3_ = WindowEvent.allocate(WindowEvent.const_42,this,null);
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_458,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_17 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_327,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_118,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_926,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1896);
         _loc1_.push(this.var_1432 != PropertyDefaults.const_1300 ? new PropertyStruct(PropertyDefaults.const_976,this.var_1432,PropertyStruct.const_38,true) : PropertyDefaults.const_1994);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1345 ? new PropertyStruct(PropertyDefaults.const_928,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_2038);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1379 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1960);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_976:
                  this.var_1432 = _loc2_.value as Boolean;
                  if(this.var_1432)
                  {
               ...
               case PropertyDefaults.const_926:
                  ...
                  break;
               case PropertyDefaults.const_1369:
