package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1444:String = "_SELECTOR";
      
      private static const const_1445:String = "_CONTENT";
       
      
      protected var var_1150:ITabSelectorWindow;
      
      protected var var_2268:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1150 = findChildByTag(const_1444) as ITabSelectorWindow;
            if(this.var_1150 != null)
            {
               this.var_1150.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2268 == null)
         {
            this.var_2268 = findChildByTag(const_1445) as IWindowContainer;
         }
      ...
      {
         return !!this.var_917 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1150.numSelectables;
      }
