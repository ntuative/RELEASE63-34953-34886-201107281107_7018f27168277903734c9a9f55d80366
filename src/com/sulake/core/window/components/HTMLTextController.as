package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_959:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1759:StyleSheet = null;
      ...
      {
         this.var_772 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      {
         if(PropertyDefaults.const_945.indexOf(param1) > -1)
         {
            this.var_772 = param1;
         }
      }
      ...
      {
         return this.var_772 == LinkTarget.const_31 ? defaultLinkTarget : this.var_772;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_1759;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1352)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_772 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_810,this.var_772,PropertyStruct.const_53,true,PropertyDefaults.const_945));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_810)
            {
               this.var_772 = _loc2_.value as String;
               break;
            }
