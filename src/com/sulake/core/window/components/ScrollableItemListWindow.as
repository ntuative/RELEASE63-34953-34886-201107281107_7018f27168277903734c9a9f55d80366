package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1371:IItemListWindow;
      
      private var var_495:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_495)
         {
            this.var_495.removeEventListener(WindowEvent.const_250,this.scrollBarEventProc);
            this.var_495.removeEventListener(WindowEvent.const_309,this.scrollBarEventProc);
            this.var_495 = null;
         }
         if(this.var_1371)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1371)
         {
            this.var_1371 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_495)
         {
            this.var_495 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_495)
            {
               this.var_495.addEventListener(WindowEvent.const_250,this.scrollBarEventProc);
               this.var_495.addEventListener(WindowEvent.const_309,this.scrollBarEventProc);
            }
         }
         return this.var_495;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_309)
         {
            this.hideScrollBar();
         }
      }
