package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_581)
         {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_838:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_581)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_838,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1990);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1329)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_966,param1.toolTipDelay,PropertyStruct.const_273,true));
         }
         else
         {
      ...
      {
         this.var_1423 = param1 == null ? "null" : param1;
      }
