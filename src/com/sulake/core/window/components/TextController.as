package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1433:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_943:Number;
      ...
      protected var var_1157:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_474,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_474 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_474,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_209);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_828 ? true : null;
         }
      ...
      {
         this.var_943 = param1;
         this._field.scrollH = this.var_943 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_943 * this.maxScrollH,this.var_612 * this.maxScrollV,width,height);
      }
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc7_ && !param1)
         {
            _loc8_ = WindowEvent.allocate(WindowEvent.const_42,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_1018,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1271));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1357 ? new PropertyStruct(PropertyDefaults.const_753,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1189) : PropertyDefaults.const_2050);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_273,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1427 ? new PropertyStruct(PropertyDefaults.const_1276,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1284) : PropertyDefaults.const_1967);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_858) ? new PropertyStruct(PropertyDefaults.const_411,this._field.textColor,PropertyStruct.const_146,true) : PropertyDefaults.const_1314);
         ...
         _loc1_.push(this.var_42.left != PropertyDefaults.const_925 ? new PropertyStruct(PropertyDefaults.const_252,this.var_42.left,PropertyStruct.const_40,true) : PropertyDefaults.const_826);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_1026 ? new PropertyStruct(PropertyDefaults.const_260,this.var_42.top,PropertyStruct.const_40,true) : PropertyDefaults.const_831);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_906 ? new PropertyStruct(PropertyDefaults.const_295,this.var_42.right,PropertyStruct.const_40,true) : PropertyDefaults.const_879);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_972 ? new PropertyStruct(PropertyDefaults.const_286,this.var_42.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_981);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1396 ? new PropertyStruct(PropertyDefaults.const_939,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1977);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_126,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_126,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_126,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
