package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_469:String = "_BTN_TEXT";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_469);
         if(_loc2_ != null)
         {
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               case WindowEvent.const_152:
                  width = 0;
                  break;
               case WindowEvent.const_250:
                  try
                  {
                     getChildByName(const_469).blend = getChildByName(const_469).blend + const_1438;
                  }
                  catch(e:Error)
                  {
                  }
                  break;
               case WindowEvent.const_309:
                  try
                  {
                     getChildByName(const_469).blend = getChildByName(const_469).blend - const_1438;
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               case WindowTouchEvent.const_738:
                  type = "null";
                  break;
               case WindowTouchEvent.const_1328:
                  type = "null";
                  break;
               case WindowTouchEvent.const_876:
                  type = "null";
            }
