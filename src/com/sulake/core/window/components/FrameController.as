package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1502:String = "_TITLE";
      
      private static const const_1500:String = "_HEADER";
      
      private static const const_1501:String = "_CONTENT";
      
      private static const const_1499:String = "_SCALER";
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1502) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1492 = findChildByTag(const_1500) as IHeaderWindow;
            if(!this.var_1492)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_194 = findChildByTag(const_1501) as IWindowContainer;
            if(!this.var_194)
            {
      ...
      {
         return findChildByTag(const_1499) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1440,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1160 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_385);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_313);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_300);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_300,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_300,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_373,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_252,_loc3_.left,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_260,_loc3_.top,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_295,0 - _loc3_.right,PropertyStruct.const_40,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_286,0 - _loc3_.bottom,PropertyStruct.const_40,_loc2_));
         return _loc1_;
      }
