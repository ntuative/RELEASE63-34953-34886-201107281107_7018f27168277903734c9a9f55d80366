package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1986:uint = 0;
      
      public static const const_971:uint = 1;
      
      public static const const_1204:uint = 2;
      
      public static const const_863:uint = 4;
      
      public static const const_1840:uint = 8;
      
      public static const const_1958:uint = 16;
      
      public static const const_2322:uint = 64;
      
      public static const const_2175:uint = 128;
      
      public static const const_1286:uint = 256;
      ...
      protected var var_240:DisplayObjectContainer;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1204:
               ...
               break;
            case GraphicContext.const_1840:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1958:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_863:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1286:
               break;
            case GraphicContext.const_1986:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_240.numChildren > 0)
               {
                  this.var_240.removeChildAt(0);
               }
            }
            this.var_240 = null;
            while(numChildren > 0)
         ...
         if(this.var_947)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2282,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2282,16777215);
                  }
                  var_368 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_240 == null)
         {
            this.var_240 = new Sprite();
            this.var_240.name = this.name + " - Child Container";
            this.var_240.mouseEnabled = false;
            addChild(this.var_240);
         }
         return this.var_240;
      }
      ...
      {
         return this.var_240 != null ? int(this.var_240.numChildren) : 0;
      }
