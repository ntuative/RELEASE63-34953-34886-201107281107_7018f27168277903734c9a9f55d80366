   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_362 = SkinLayoutEntity.const_535;
                  break;
               case "move":
                  _loc5_.var_362 = SkinLayoutEntity.const_342;
                  break;
               case "strech":
                  _loc5_.var_362 = SkinLayoutEntity.const_655;
                  break;
               case "tiled":
                  _loc5_.var_362 = SkinLayoutEntity.const_364;
                  break;
               case "center":
                  _loc5_.var_362 = SkinLayoutEntity.const_564;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_363 = SkinLayoutEntity.const_535;
                  break;
               case "move":
                  _loc5_.var_363 = SkinLayoutEntity.const_342;
                  break;
               case "strech":
                  _loc5_.var_363 = SkinLayoutEntity.const_655;
                  break;
               case "tiled":
                  _loc5_.var_363 = SkinLayoutEntity.const_364;
                  break;
               case "center":
                  _loc5_.var_363 = SkinLayoutEntity.const_564;
            }
         }
