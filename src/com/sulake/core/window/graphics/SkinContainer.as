package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1138:uint = 8;
      
      private static const const_1685:String = "skin";
      
      private static const const_1688:String = "bitmap";
      
      private static const const_1687:String = "fill";
      
      private static const const_1684:String = "text";
      
      private static const const_1689:String = "label";
      
      private static const const_1686:String = "shape";
      ...
      private var var_2895:Dictionary;
      
      private var var_2894:Dictionary;
      
      private var var_2893:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2895 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2106,this.var_2895);
         this.var_2894 = new Dictionary();
         this.var_2893 = new Dictionary();
         StateCodeTable.fillTables(this.var_2894,this.var_2893);
         this.var_492 = new Dictionary();
         this.var_492[const_1685] = BitmapSkinRenderer;
         this.var_492[const_1688] = BitmapDataRenderer;
         this.var_492[const_1687] = FillSkinRenderer;
         this.var_492[const_1684] = TextSkinRenderer;
         this.var_492[const_1689] = LabelRenderer;
         this.var_492[const_1686] = ShapeSkinRenderer;
         this.var_492[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_492[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_369 == null)
         {
            var_369 = new Array();
            var_369.push(WindowState.const_69);
            var_369.push(WindowState.const_87);
            var_369.push(WindowState.const_97);
            var_369.push(WindowState.const_56);
            var_369.push(WindowState.const_93);
            var_369.push(WindowState.const_89);
            var_369.push(WindowState.const_90);
            var_369.push(WindowState.const_104);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3060 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2106[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1107[param1] = new Array(const_1138);
         }
         this.var_1107[param1][param2] = param3;
         if(this.var_1106[param1] == null)
         {
            this.var_1106[param1] = new Array(const_1138);
         }
         this.var_1106[param1][param2] = param4;
      }
