package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static const const_506:uint = 0;
      
      public static const const_1933:uint = 1;
      ...
      public static const const_2241:int = 3;
      ...
      private static var var_1928:uint = const_506;
      
      private static var stage:Stage;
      
      private static var var_188:IWindowRenderer;
       
      
      private var var_2599:EventProcessorState;
      
      private var var_2600:IWindowContextStateListener;
      ...
      protected var var_1429:Error;
      
      protected var var_2277:int = -1;
      
      protected var var_1428:IInternalWindowServices;
      
      protected var var_1722:IWindowParser;
      
      protected var var_3071:IWindowFactory;
      
      protected var var_96:IDesktopWindow;
      
      protected var var_1721:SubstituteParentController;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         this.var_146 = param5;
         this.var_1428 = new ServiceManager(this,param5);
         this.var_3071 = param3;
         this.var_1722 = new WindowParser(this);
         ...
         this.var_2599 = new EventProcessorState(var_188,this.var_96,this.var_96,null,this.var_2600);
         inputMode = const_506;
         this.var_1721 = new SubstituteParentController(this);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_96.destroy();
            this.var_96 = null;
            this.var_1721.destroy();
            this.var_1721 = null;
            if(this.var_1428 is IDisposable)
            {
               IDisposable(this.var_1428).dispose();
            }
            this.var_1428 = null;
      ...
      public function create(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:Rectangle, param7:Function, param8:IWindow, param9:uint, param10:Array = null, param11:Array = null) : IWindow
      {
         ...
         if(_loc13_ == null)
         {
            this.handleError(WindowContext.const_1953,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_628)
         {
            param1.destroy();
         }
         return true;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         if(!this.disposed)
         {
            var_188.addToRenderQueue(WindowController(param1),param2,param3);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var_681.process(this.var_2599,var_432);
         this.var_607 = false;
      }
