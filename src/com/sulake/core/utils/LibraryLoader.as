package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2089:uint = 1;
      
      protected static const const_2091:uint = 2;
      
      protected static const const_2088:uint = 4;
      
      protected static const const_2090:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_2039:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1398:Boolean = false;
      
      public static const const_1788:int = 2;
      
      private static var var_1134:Array = new Array();
      
      private static var var_924:Array = new Array();
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1398)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_924[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_924.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_924.length < const_1788 && false)
            {
               _loc1_ = var_1134.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1160 ? uint(this.var_1434 - this.var_2285) : uint(getTimer() - this.var_2285);
      }
      ...
      {
         if(!this.var_1160 && !_disposed && this.var_1433 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_270,const_2039 - this.var_1433);
            if(this.var_3081)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_519 == LibraryLoader.const_2090)
         {
