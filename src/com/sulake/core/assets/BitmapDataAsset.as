package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_581 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_125 is Class)
         {
            _loc1_ = new this.var_125() as Bitmap;
            if(_loc1_ != null)
            {
            ...
            this._bitmap = new this.var_125() as BitmapData;
            if(this._bitmap != null)
            {
               this.var_125 = null;
               return;
         ...
         if(this.var_125 is Bitmap)
         {
            this._bitmap = Bitmap(this.var_125).bitmapData;
            if(this._bitmap == null)
            {
         ...
         if(this.var_125 is BitmapData)
         {
            this._bitmap = this.var_125 as BitmapData;
            if(this._bitmap != null)
            {
               this.var_125 = null;
               return;
         ...
         if(this.var_125 is BitmapDataAsset)
         {
            this._bitmap = BitmapDataAsset(this.var_125)._bitmap;
            this._offset = BitmapDataAsset(this.var_125)._offset;
            this.var_1679 = BitmapDataAsset(this.var_125).var_1679;
            this.var_1680 = BitmapDataAsset(this.var_125).var_1680;
            if(this._bitmap != null)
            {
               this.var_125 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1679 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1680 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
