package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      protected var var_1152:LoaderContext;
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1152 = new LoaderContext();
         this.var_1152.checkPolicyFile = true;
         ...
         {
            this.var_44.load(param2,this.var_1152);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_366 = 0;
         this.var_44.load(param1,this.var_1152);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_366 < var_3073)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1151 + (this.var_1151.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_366),this.var_1152);
               return true;
            }
         }
         return false;
