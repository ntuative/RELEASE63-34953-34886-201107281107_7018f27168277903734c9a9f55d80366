package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1331:String = "AssetLibraryReady";
      
      public static const const_934:String = "AssetLibraryLoaded";
      
      public static const const_1833:String = "AssetLibraryUnloaded";
      
      public static const const_1947:String = "AssetLibraryLoadError";
      
      private static const const_691:String = "name";
      
      private static const const_1070:String = "asset";
      
      private static const const_1069:String = "param";
      ...
      private static var var_1876:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_546:uint = 0;
      
      private static var var_1005:Array = new Array();
      ...
      private var var_1006:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_1003 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_661 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1068);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1070);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_691);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1069);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_661 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1005.splice(var_1005.indexOf(this),1);
            --var_546;
            this.var_545 = null;
            this.var_1003 = null;
            this.var_179 = null;
      ...
      {
         if(this.var_661 == param1.url && this.var_1004)
         {
            if(!this.var_1006 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_662);
            }
            this.var_1006 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1331));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_1003)
         {
            delete this.var_1003[_loc1_];
         }
         if(this.var_44 != null)
         {
            this.var_44.dispose();
         ...
         this.var_1004 = false;
         this.var_661 = null;
         dispatchEvent(new Event(AssetLibrary.const_1833));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1003[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1305,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1317,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_461;
                     this.var_462.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_462.length ? this.getAssetByName(this.var_462[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_179)
         {
            ...
            {
               return this.var_462.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_179[param1] != null || (this.var_662 != null ? this.var_662[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1876.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_179)
            {
               if(this.var_179[_loc2_] == param1)
               {
                  this.var_462.splice(this.var_462.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_460.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_460[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_460[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_460)
         {
            _loc3_ = AssetTypeDeclaration(this.var_460[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_460)
         {
            _loc4_ = AssetTypeDeclaration(this.var_460[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_661 = _loc2_.url;
         if(this.var_1006)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_662);
         }
         this.var_1004 = true;
         dispatchEvent(new Event(AssetLibrary.const_934));
         dispatchEvent(new Event(AssetLibrary.const_1331));
         if(this.var_1006)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1947));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1068);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1070);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_691) && _loc3_.attribute(const_691).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_661 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_662[param1]);
                     _loc6_ = _loc3_.child(const_1069);
